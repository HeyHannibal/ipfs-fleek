...
var _gsScope;
!(function (t, e, i, n) {
  (("visibilityState" in e ||
    "webkitVisibilityState" in e ||
    "mozVisibilityState" in e) &&
    "?fallback" !== t.location.search) ||
    (function () {
      var t = function () {};
      console.error || (console.error = t);
      e.body.className += " fallback on-ready";
      var n = e.head;
      n.querySelectorAll('meta[name="viewport"]').length ||
        n.insertAdjacentHTML(
          "afterbegin",
          '<meta charset="utf-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge">  <meta name="HandheldFriendly" content="True">  <meta name="MobileOptimized" content="0"> <meta name="viewport" content="user-scalable=no, width=device-width, initial-scale=1, maximum-scale=1"> '
        );
      for (var s = e.querySelectorAll("img"), r = 0; r < s.length; r++) {
        var o = s[r],
          a = o.getAttribute("data-src");
        a && ((o.src = a), o.removeAttribute("data-src"));
      }
      for (var l = e.querySelectorAll("[hash]"), u = 0; u < l.length; u++) {
        var h = l[u];
        h.hasAttribute("id") ||
          (h.setAttribute("id", "/" + h.getAttribute("hash")), h.removeAttribute("hash"));
      }
      var c = e.querySelector("aside > header");
      throw (
        (c && e.body.insertAdjacentHTML("afterbegin", c.outerHTML),
        (i.init = t),
  ...
  (function (t, e, i) {
    ...
    function o(t, e, i, n, s, r) {
      var o,
        ...
        h = i.type;
      if (!v[t]) return [];
      for ("keyup" == h && u(t) && (e = [t]), o = 0; o < v[t].length; ++o)
        if (
          ((a = v[t][o]),
          !(
            (!n && a.seq && b[a.seq] != a.level) ||
            h != a.action ||
            (("keypress" != h || i.metaKey || i.ctrlKey) &&
              e.sort().join(",") !== a.modifiers.sort().join(","))
          ))
        ) {
          var c = n && a.seq == n && a.level == r;
          ((!n && a.combo == s) || c) && v[t].splice(o, 1), l.push(a);
        }
      return l;
    }
    function a(t, e, i, n) {
      P.stopCallback(e, e.target || e.srcElement, i, n) ||
        !1 !== t(e, i) ||
    ...
    function h(t, e) {
      var i,
        ...
        s,
        r = [];
      for (i = "+" === t ? ["+"] : t.split("+"), s = 0; s < i.length; ++s)
        (n = i[s]),
          _[n] && (n = _[n]),
          e && "keypress" != e && m[n] && ((n = m[n]), r.push("shift")),
          u(n) && r.push(n);
      if (((i = n), !(s = e))) {
        if (!p)
          for (var o in ((p = {}), d))
      ...
      return (
        "keypress" == s && r.length && (s = "keydown"),
        { key: n, modifiers: r, action: s }
      );
    }
    function c(t, e, i, n, l) {
      ...
      1 < u.length
        ? (function (t, e, i, n) {
            function o(e) {
              return function () {
                (T = e), ++b[t], clearTimeout(f), (f = setTimeout(r, 1e3));
              };
            }
            function l(e) {
              a(i, e, t), "keyup" !== n && (w = s(e)), setTimeout(r, 10);
            }
        ...
        : ((i = h(t, i)),
          (v[i.key] = v[i.key] || []),
          o(i.key, i.modifiers, { type: i.action }, n, t, l),
    ...
    for (i = 0; 9 >= i; ++i) d[i + 96] = i;
    n(e, "keypress", l), n(e, "keydown", l), n(e, "keyup", l);
    var P = {
      bind: function (t, e, i) {
        t = t instanceof Array ? t : [t];
        for (var n = 0; n < t.length; ++n) c(t[n], e, i);
        return this;
      },
      unbind: function (t, e) {
      ...
      stopCallback: function (t, e) {
        return (
          !(-1 < (" " + e.className + " ").indexOf(" mousetrap ")) &&
          ("INPUT" == e.tagName ||
            "SELECT" == e.tagName ||
            "TEXTAREA" == e.tagName ||
            e.isContentEditable)
      ...
      handleKey: function (t, e, i) {
        ...
        for (n = 0; n < s.length; ++n)
          s[n].seq
            ? s[n].level == l &&
              ((h = !0), (e[s[n].seq] = 1), a(s[n].callback, i, s[n].combo, s[n].seq))
            : h || a(s[n].callback, i, s[n].combo);
        (s = "keypress" == i.type && x),
          i.type != T || u(t) || s || r(e),
          (x = h && "keydown" == i.type);
      },
    };
    (t.Mousetrap = P), "function" == typeof define && define.amd && define(P);
  })(window, document),
  (function (t, e) {
    "use strict";
    if ("function" == typeof define && define.amd) define(["exports"], e);
    else if ("object" == typeof exports) e(exports);
    else {
      var i = {};
      (t.PubSub = i), e(i);
    }
    ...
    function o(t, i, n, o) {
      var a,
        l = e[i],
        u = o ? r : s;
      if (e.hasOwnProperty(i)) for (a in l) l.hasOwnProperty(a) && u(l[a], t, n);
    }
    function a(t, i, s, r) {
      var a,
        l,
        ...
        h =
          ...
          function () {
            var t = String(a),
              e = t.lastIndexOf(".");
            for (o(a, a, l, u); -1 !== e; )
              (e = (t = t.substr(0, e)).lastIndexOf(".")), o(a, t, l, u);
          });
      return (
        !!(function (t) {
          for (
    ...
    (t.publish = function (e, i) {
      ...
      (t.unsubscribe = function (t) {
        var i,
          n,
          s,
          r = "string" == typeof t && e.hasOwnProperty(t),
          o = !r && "string" == typeof t,
          a = "function" == typeof t,
          l = !1;
        if (!r) {
          for (i in e)
            if (e.hasOwnProperty(i)) {
              ...
              if (a)
                for (s in n) n.hasOwnProperty(s) && n[s] === t && (delete n[s], (l = !0));
            }
          return l;
        }
        delete e[t];
    ...
    _gsScope._gsDefine(
      ...
      function (t, e, i) {
        ...
        (r.version = "1.18.4"),
            ...
            if (
              ...
              for (
                !1 !== this._lazy && (this._lazy = !1),
                  this._active ||
                    (!this._paused && this._time !== d && t >= 0 && (this._active = !0)),
                  0 === g &&
                    (2 === this._initted && t > 0 && this._init(),
                    this._startAt &&
                      (t >= 0 ? this._startAt.render(t, e, i) : s || (s = "_dummyGS")),
                    this.vars.onStart &&
          ...
          (r.staggerTo = r.allTo =
            function (t, e, o, a, h, p, f) {
              ...
              for (
                u(t) ||
                  ("string" == typeof t && (t = i.selector(t) || t), l(t) && (t = n(t))),
                  t = t || [],
                ...
                if ((w && s(g, t, m), x)) {
                  for (_ in ((x = g.startAt = {}), o.startAt)) x[_] = o.startAt[_];
                  s(g.startAt, t, m);
                }
                (g.delay = v + (g.delay || 0)),
        ...
        var p = function (t, e) {
            for (var n = [], s = 0, r = t._first; r; )
              r instanceof i
                ? (n[s++] = r)
                : (e && (n[s++] = r), (s = (n = n.concat(p(r, e))).length)),
                (r = r._next);
            return n;
          },
              ...
              if (
                ...
                for (h in ((s = []), f))
                  for (o = f[h].target.parentNode; o; )
                    o === t && (s = s.concat(f[h].tweens)), (o = o.parentNode);
                for (p = s.length, c = 0; p > c; c++)
          ...
          return (
            ...
            (m.staggerTo = function (t, e, s, r, o, l, u, h) {
              ...
              for (
                "string" == typeof t && (t = i.selector(t) || t),
                  a((t = t || [])) && (t = g(t)),
                  0 > (r = r || 0) && ((t = g(t)).reverse(), (r *= -1)),
                  d = 0;
                d < t.length;
                d++
              )
                (c = p(s)).startAt &&
                  ((c.startAt = p(c.startAt)), c.startAt.cycle && f(c.startAt, t, d)),
                  _ && f(c, t, d),
                  m.to(t[d], e, c, d * r);
              return this.add(m, o);
            }),
            ...
            (m.add = function (s, r, o, a) {
              ...
              if (
                ...
                if (s instanceof Array || (s && s.push && l(s))) {
                  for (
                    o = o || "normal", a = a || 0, u = r, h = s.length, c = 0;
                    h > c;
                    c++
                  )
                    l((p = s[c])) && (p = new n({ tweens: p })),
                      this.add(p, u),
                      "string" != typeof p &&
                        "function" != typeof p &&
                        ("sequence" === o
              ...
              if (e instanceof t) {
                ...
                return (
                  (e._startTime =
                    ...
                    (e._reversed ? e.totalDuration() - e._totalTime : e._totalTime) /
                      e._timeScale),
                  this
                );
              }
            ...
            (m.render = function (t, e, i) {
                ...
                (this._totalTime = this._time = f),
                  this._reversed ||
                    ...
                    0 === this._duration &&
                      ...
                      this._rawPrevTime !== t &&
                      this._first &&
                      ((l = !0), this._rawPrevTime > s && (a = "onReverseComplete"))),
                  (this._rawPrevTime =
              ...
              if ((this._time !== d && this._first) || i || l || c) {
                if (
                  ...
                  for (
                    n = this._first;
                    n && ((o = n._next), p === this._time && (!this._paused || _));
                  ...
                  for (
                    n = this._last;
                    n && ((o = n._prev), p === this._time && (!this._paused || _));
            ...
            (m.getTweensOf = function (t, e) {
              var n,
                ...
                a = 0;
              for (
                r && this._enabled(!0, !0), s = (n = i.getTweensOf(t)).length;
                --s > -1;
            ...
            (m.duration = function (t) {
              return arguments.length
                ? (0 !== this.duration() && 0 !== t && this.timeScale(this._duration / t),
                  this)
            ...
            (u.render = function (t, e, i) {
              ...
              if (this._cycle !== x && !this._locked) {
                ...
                if (
                  ...
                  return;
                if (
                  (P && ((m = T ? g + 1e-4 : -1e-4), this.render(m, !0, !1)),
                  (this._locked = !1),
                  this._paused && !w)
                )
                  return;
              ...
              if ((this._time !== m && this._first) || i || h || p) {
                if (
                  ...
                  for (
                    n = this._first;
                    n && ((l = n._next), f === this._time && (!this._paused || w));
                  ...
                  for (
                    n = this._last;
                    n && ((l = n._prev), f === this._time && (!this._paused || w));
      ...
      (c = function (t, e, i, n, a) {
        ...
        for (l = 0; x > l; l++)
          (u = (f = t[T]).a),
            ...
            a
              ? ((y = s[l]),
                (w = (((b = r[l]) + y) * e * 0.25) / (n ? 0.5 : o[l] || 0.5)),
                (m =
                  c -
                  ((d = c - (c - u) * (n ? 0.5 * e : 0 !== y ? w / y : 0)) +
                    ((((g = c + (p - c) * (n ? 0.5 * e : 0 !== b ? w / b : 0)) - d) *
                      ((3 * y) / (y + b) + 0.5)) /
                      4 || 0))))
              : (m = c - ((d = c - (c - u) * e * 0.5) + (g = c + (p - c) * e * 0.5)) / 2),
            (d += m),
            (g += m),
            (f.c = _ = d),
            ...
            (f.ba = P - u),
            i
              ? ((v = h(u, P, _, c)), t.splice(T, 1, v[0], v[1], v[2], v[3]), (T += 4))
              : T++,
            (P = g);
        ((f = t[T]).b = P),
          (f.c = P + 0.4 * (f.d - P)),
          ...
          (f.ca = f.c - f.a),
          (f.ba = P - f.a),
          i && ((v = h(f.a, P, f.c, f.d)), t.splice(T, 1, v[0], v[1], v[2], v[3]));
      }),
      (p = function (t, e, i, n) {
        var o,
          a,
        ...
        if (0 > (o = t.length - 2))
          return (f[0] = new u(t[0][e], 0, 0, t[-1 > o ? 0 : 1][e])), f;
        for (a = 0; o > a; a++)
          (l = t[a][e]),
            (h = t[a + 1][e]),
            (f[a] = new u(l, 0, 0, h)),
            i &&
              ...
              (s[a] = (s[a] || 0) + (h - l) * (h - l)),
              (r[a] = (r[a] || 0) + (c - h) * (c - h)));
        return (f[a] = new u(t[a][e], 0, 0, t[a + 1][e])), f;
      }),
      (f = function (t, e, i, n, l, u) {
        ...
        t[0]))
          w.push(f);
        if (t.length > 1) {
          for (y = t[t.length - 1], v = !0, h = w.length; --h > -1; )
            if (((f = w[h]), Math.abs(x[f] - y[f]) > 0.05)) {
              v = !1;
              break;
            }
          v && ((t = t.concat()), u && t.unshift(u), t.push(t[1]), (u = t[t.length - 3]));
        }
        for (s.length = r.length = o.length = 0, h = w.length; --h > -1; )
          (f = w[h]), (a[f] = -1 !== l.indexOf("," + f + ",")), (b[f] = p(t, f, a[f], u));
        for (h = s.length; --h > -1; ) (s[h] = Math.sqrt(s[h])), (r[h] = Math.sqrt(r[h]));
        if (!n) {
          for (h = w.length; --h > -1; )
            if (a[f])
              for (_ = (d = b[w[h]]).length - 1, g = 0; _ > g; g++)
                (m = d[g + 1].da / r[g] + d[g].da / s[g] || 0),
                  (o[g] = (o[g] || 0) + m * m);
          for (h = o.length; --h > -1; ) o[h] = Math.sqrt(o[h]);
        }
        for (h = w.length, g = i ? 4 : 1; --h > -1; )
          (d = b[(f = w[h])]),
            c(d, e, i, n, a[f]),
      ...
      (d = function (t, e, i) {
        for (var n, s, r, o, a, l, u, h, c, p, f, d = 1 / i, g = t.length; --g > -1; )
          for (
            r = (p = t[g]).a, o = p.d - r, a = p.c - r, l = p.b - r, n = s = 0, h = 1;
            i >= h;
            h++
          )
      ...
      (g = _gsScope._gsDefine.plugin({
            ...
            ((this._beziers =
              "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type
                ...
                : (function (t, e, i) {
                    ...
                    for (l = v.length; --l > -1; ) {
                      for (g[(p = v[l])] = a = [], f = 0, c = t.length, h = 0; c > h; h++)
                        (n =
                          null == i
                            ? t[h][p]
                            : "string" == typeof (d = t[h][p]) && "=" === d.charAt(1)
                            ? i[p] + Number(d.charAt(0) + d.substr(2))
                            : Number(d)),
                          _ && h > 1 && c - 1 > h && (a[f++] = (n + a[f - 2]) / 2),
                          (a[f++] = n);
                      for (c = f - m + 1, f = 0, h = 0; c > h; h += m)
                        (n = a[h]),
                          (s = a[h + 1]),
                          (r = a[h + 2]),
                          (o = 2 === m ? 0 : a[h + 3]),
            ...
            for (
              ...
              (n = p[r][2]),
                (this._initialRotations[r] =
                  (this._func[n] ? this._func[n].call(this._target) : this._target[n]) ||
                  0);
            }
        ...
        set: function (t) {
          ...
          if (this._timeRes) {
            ...
            if (
              ((e = s), (t -= this._l1), (s = this._si), t > this._s2 && s < c.length - 1)
            ) {
          ...
          for (i = 1 - a, s = this._props.length; --s > -1; )
            (r = this._props[s]),
              (l =
                (a * a * (o = this._beziers[r][e]).da + 3 * i * (a * o.ca + i * o.ba)) *
                  a +
                o.a),
      ...
      _gsScope._gsDefine(
        ...
        function (t, e) {
          ...
          var h,
            ...
            X = function (t) {
              return B.createElementNS
                ? B.createElementNS("http://www.w3.org/1999/xhtml", t)
                : B.createElement(t);
            },
            Y = X("div"),
            j = X("img"),
            H = (o._internals = { _specialProps: l }),
            ...
            V =
              ...
              !!_ &&
                ((_.style.cssText = "top:1px;opacity:.55;"),
                /^0.55/.test(_.style.opacity))),
            U = function (t) {
              return T.test(
                "string" == typeof t
                  ? t
            ...
            J = (H.convertToPixels = function (t, i, n, s, r) {
              ...
              if ((f && (n = -n), "%" === s && -1 !== i.indexOf("border")))
                ...
                if (
                  ...
                  if (
                    ((l = (c = t.parentNode || B.body)._gsCache),
                    (u = e.ticker.frame),
                    l && h && l.time === u)
                  )
            ...
            et = function (t, e) {
              ...
              if ((e = e || Q(t, null)))
                if ((i = e.length))
                  for (; --i > -1; )
                    (-1 === (s = e[i]).indexOf("-transform") || Rt === s) &&
                      (r[s.replace(O, k)] = e.getPropertyValue(s));
                else
                  for (i in e)
              ...
              return (
                null == t
                  ...
                  : ((s = 360),
                    ...
                    (o =
                      ((l = "=" === t.charAt(1))
                        ? parseInt(t.charAt(0) + "1", 10) * parseFloat(r[0].substr(2))
                        : parseFloat(r[0])) *
                        (-1 === t.indexOf("rad") ? 1 : z) -
                      (l ? 0 : e)),
                    r.length &&
          ...
          var gt = function (t, e, i, n) {
                ...
                ? (s = e
                    ? function (t) {
                        ...
                        if ("number" == typeof t) t += c;
                          ...
                          for (d = t.replace(D, "|").split("|"), f = 0; f < d.length; f++)
                            d[f] = s(d[f]);
                          return d.join(",");
                        }
                        if (
                    ...
                    : function (t) {
                        ...
                        if ("number" == typeof t) t += c;
                          ...
                          for (r = t.replace(D, "|").split("|"), p = 0; p < r.length; p++)
                            r[p] = s(r[p]);
                          return r.join(",");
                        }
            ...
            vt =
              ((H._parseToProxy = function (t, e, i, n, s, r) {
                var o,
                  a,
                  l,
                  u,
                ...
                return { proxy: p, end: f, firstMPT: u, pt: h };
              }),
            ...
            bt = (o.parseComplex = function (t, e, i, n, s, r, a, l, u, c) {
              ...
              for (
                ...
                if (((g = A[p]), (m = O[p]), (w = parseFloat(g)) || 0 === w))
                  a.appendXtra(
                    "",
                    w,
                    at(m, w),
                  ...
                  (S = ")" + ((S = m.indexOf(")") + 1) ? m.substr(S) : "")),
                    ...
                    (g = pt(g, C)),
                    (m = pt(m, C)),
                    (x = g.length + m.length > 6) && !V && 0 === m[3]
                      ? ((a["xs" + a.l] += a.l ? " transparent" : "transparent"),
                        (a.e = a.e.split(O[p]).join("transparent")))
                      : (V || (x = !1),
                        C
                          ? a
                              .appendXtra(
                          ...
                          : a
                              ...
                              .appendXtra("", g[2], m[2] - g[2], x ? "," : S, !0),
                        x &&
                          ((g = g.length < 4 ? 1 : g[3]),
                          a.appendXtra("", g, (m.length < 4 ? 1 : m[3]) - g, S, !1))),
                    (dt.lastIndex = 0);
                else if ((_ = g.match(v))) {
                  if (!(b = m.match(y)) || b.length !== _.length) return a;
                  for (d = 0, f = 0; f < _.length; f++)
                    (P = _[f]),
                      (T = g.indexOf(P, d)),
                      a.appendXtra(
                        g.substr(d, T - d),
          ...
          var xt = function (t, e) {
              (e = e || {}),
                ...
                (l[t] = l[this.p] = this),
                (this.format =
                  e.formatter || gt(e.defaultValue, e.color, e.collapsible, e.multi)),
              ...
              if (!l[t]) {
                ...
                Tt(t, {
                  parser: function (t, i, n, s, r, o, u) {
                    ...
                    return h
                      ? (h._cssRegister(), l[n].parse(t, i, n, s, r, o, u))
                      : (G(), r);
                  },
                });
              }
          ...
          ((u = xt.prototype).parseComplex = function (t, e, i, n, s, r) {
            ...
            (u.parse = function (t, e, i, n, r, o, a) {
              return this.parseComplex(
                t.style,
                this.format(K(t, this.p, s, !1, this.dflt)),
                this.format(e),
                r,
                o
              );
            ...
            (o.registerSpecialProp = function (t, e, i) {
              Tt(t, {
                parser: function (t, n, s, r, o, a, l) {
                  ...
                  return (u.plugin = a), (u.setRatio = e(t, n, r._tween, s)), u;
                },
                priority: i,
              });
            }),
          ...
          var St,
            ...
            It = (H.Transform = function () {
              (this.perspective = parseFloat(o.defaultTransformPerspective) || 0),
                (this.force3D =
                  !(!1 === o.defaultForce3D || !Dt) && (o.defaultForce3D || "auto"));
            }),
            Nt = window.SVGElement,
            zt = function (t, e, i) {
              var n,
                s = B.createElementNS("http://www.w3.org/2000/svg", t),
                r = /([a-z])([A-Z])/g;
              for (n in i)
            ...
            Bt =
              ((Et = g || (/Android/i.test(q) && !window.chrome)),
              B.createElementNS &&
                !Et &&
                ((Ct = zt("svg", Ft)),
                (Ot = (At = zt("rect", Ct, {
            ...
            Ht = function (t, e) {
              ...
              if (
                ...
                (a.svg || (t.getBBox && Yt(t))) &&
                  (i &&
                    -1 !== (t.style[Lt] + "").indexOf("matrix") &&
                    ((n = t.style[Lt]), (i = 0)),
            ...
            qt = (H.getTransform = function (t, i, n, r) {
              ...
              var a,
                ...
                g =
                  (Dt &&
                    (parseFloat(K(t, Mt, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin)) ||
                  0,
                m = parseFloat(o.defaultTransformPerspective) || 0;
              if (
                ((f.svg = !(!t.getBBox || !Yt(t))),
                f.svg &&
                  (Xt(
                    t,
                    K(t, Mt, s, !1, "50% 50%") + "",
                ...
                if (16 === a.length) {
                  var _,
                    ...
                    F = Math.atan2(O, R);
                  f.zOrigin &&
                    ((M = k * (I = -f.zOrigin) - a[12]),
                    (D = L * I - a[13]),
                    (I = R * I + f.zOrigin - a[14])),
                    (f.rotationX = F * z),
                    F &&
                      ((_ = C * (b = Math.cos(-F)) + k * (w = Math.sin(-F))),
                      (v = A * b + L * w),
                      (y = O * b + R * w),
                      (k = C * -w + k * b),
                      (L = A * -w + L * b),
                    ...
                    (f.rotationY = F * z),
                    F &&
                      ((v = T * (b = Math.cos(-F)) - L * (w = Math.sin(-F))),
                      (y = P * b - R * w),
                      (L = T * w + L * b),
                      (R = P * w + R * b),
                      (N = S * w + N * b),
                    ...
                    (f.rotation = F * z),
                    F &&
                      ((x = x * (b = Math.cos(-F)) + C * (w = Math.sin(-F))),
                      (v = T * b + A * w),
                      (A = T * -w + A * b),
                      (O = P * -w + O * b),
                      (T = v)),
                    ...
                    (f.scaleX = ((1e5 * Math.sqrt(x * x + T * T) + 0.5) | 0) / 1e5),
                    (f.scaleY = ((1e5 * Math.sqrt(A * A + L * L) + 0.5) | 0) / 1e5),
                    (f.scaleZ = ((1e5 * Math.sqrt(O * O + R * R) + 0.5) | 0) / 1e5),
                    ...
                    (f.z = I),
                    f.svg &&
                      ((f.x -= f.xOrigin - (f.xOrigin * x - f.yOrigin * C)),
                ...
                for (l in ((f.zOrigin = g), f)) f[l] < 2e-5 && f[l] > -2e-5 && (f[l] = 0);
              }
              return (
                n &&
                  ((t._gsTransform = f),
                ...
                if (
                  (null != n.ox &&
                    ((b +=
                      ...
                      (f * a + (d = (n.oyp ? _ * n.oy * 0.01 : n.oy) - _ / 2) * l)),
                    (w += d - (f * u + d * h))),
                  v
                    ? (y +=
                        ", Dx=" +
                  ...
                  for (
                    f = n.ieOffsetX || 0,
                      ...
                      n.ieOffsetX = Math.round(
                        (m - ((0 > a ? -a : a) * m + (0 > l ? -l : l) * _)) / 2 + b
                      ),
                      n.ieOffsetY = Math.round(
                        (_ - ((0 > h ? -h : h) * _ + (0 > u ? -u : u) * m)) / 2 + w
                      ),
                      wt = 0;
                    4 > wt;
                    wt++
                    ...
                    (C =
                      (i =
                        -1 !== (P = p[(S = st[wt])]).indexOf("px")
                          ? parseFloat(P)
                          : J(this.t, S, parseFloat(P), P.replace(x, "")) || 0) !== n[S]
                        ? 2 > wt
                          ? -n.ieOffsetX
                          : -n.ieOffsetY
                        : 2 > wt
                        ...
                        : d - n.ieOffsetY),
                      (c[S] =
                        (n[S] = Math.round(i - C * (0 === wt || 2 === wt ? 1 : A))) +
                        "px");
                }
              }
            },
                  ...
                  if (
                      ...
                      ? ((A *= N),
                        ...
                        z &&
                          ...
                          St &&
                            ...
                            ((g = this.t.getBBox()),
                            (M += 0.01 * S.xPercent * g.width),
                            (D += 0.01 * S.yPercent * g.height)),
                          (g = 1e-6) > M && M > -g && (M = 0),
                          g > D && D > -g && (D = 0)),
                        (b =
                          ((e * P) | 0) / P +
                    ...
                    (u = 1),
                      ...
                      (A = E * N) &&
                        ...
                        (s *= m)),
                      (A = O * N) &&
                        ((v = i * (m = Math.cos(A)) + n * (_ = Math.sin(A))),
                        (y = r * m + o * _),
                        (l = u * _),
                        (c = p * _),
                        (n = i * -_ + n * m),
          ...
          ((u = It.prototype).x =
                ...
                parser: function (t, e, i, n, r, a, l) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      if ("object" == typeof g) for (c in g) x[c] = g[c];
                      else x.rotation = g;
                    "string" == typeof x.x &&
                      -1 !== x.x.indexOf("%") &&
                      ((h.x = 0), (h.xPercent = lt(x.x, u.xPercent))),
                      "string" == typeof x.y &&
                        -1 !== x.y.indexOf("%") &&
                        ((h.y = 0), (h.yPercent = lt(x.y, u.yPercent))),
                      (h.rotation = ut(
                        "rotation" in x
                          ? x.rotation
                          : "shortRotation" in x
                      ...
                      (h.skewY = ut(x.skewY, u.skewY)) &&
                        ((h.skewX += h.skewY), (h.rotation += h.skewY));
                  }
                  for (
                    Dt && null != x.force3D && ((u.force3D = x.force3D), (d = !0)),
                  ...
                  return (
                    ...
                    u.svg &&
                      ...
                      (m !== u.xOffset || _ !== u.yOffset) &&
                        ((r = yt(u, "xOffset", y ? m : u.xOffset, u.xOffset, r, P)),
                    ...
                    d &&
                      (n._transformType =
                        (u.svg && St) || (!f && 3 !== this._transformType) ? 2 : 3),
                    r
                  );
                },
                prefix: !0,
                  ...
                  this.p.indexOf("border") && (P[u] = Z(P[u])),
                    ...
                    v !== y &&
                      ...
                      "%" === v
                        ? ((p = (w / m) * 100 + "%"), (c = (x / _) * 100 + "%"))
                        : "em" === v
                        ? ((p = w / (T = J(t, "borderLeft", 1, "em")) + "em"),
                          (c = x / T + "em"))
                        : ((p = w + "px"), (c = x + "px")),
                      b && ((f = parseFloat(p) + g + v), (h = parseFloat(c) + g + v))),
            ...
            Tt("backgroundPosition", {
              ...
              parser: function (t, e, i, n, r, o) {
                ...
                if (
                  ...
                  _.split(",").length < 2 &&
                  (p = K(t, "backgroundImage").replace(E, "")) &&
                  "none" !== p
                ) {
                  for (
                    a = m.split(" "), l = _.split(" "), j.setAttribute("src", p), u = 2;
                    --u > -1;

                  )
                    (h = -1 !== (m = a[u]).indexOf("%")) !== (-1 !== l[u].indexOf("%")) &&
                      ((c =
                        0 === u ? t.offsetWidth - j.width : t.offsetHeight - j.height),
                      (a[u] = h
            ...
            Tt("backgroundSize", { defaultValue: "0 0", formatter: ot }),
            ...
            Tt("margin", { parser: mt("marginTop,marginRight,marginBottom,marginLeft") }),
            Tt("padding", {
              ...
              parser: function (t, e, i, n, r, o) {
                ...
                return (
                  9 > g
                    ...
                    : ((a = this.format(K(t, this.p, s, !1, this.dflt))),
                      (e = this.format(e))),
            ...
            Tt("border", {
              ...
              parser: function (t, e, i, n, r, o) {
                return this.parseComplex(
                  t.style,
                  this.format(
                    K(t, "borderTopWidth", s, !1, "0px") +
                      " " +
                      K(t, "borderTopStyle", s, !1, "solid") +
                      " " +
                      K(t, "borderTopColor", s, !1, "#000")
                  ),
                  this.format(e),
                  r,
                  o
              ...
              formatter: function (t) {
                var e = t.split(" ");
                return (
                  e[0] + " " + (e[1] || "solid") + " " + (t.match(dt) || ["#000"])[0]
                );
              },
            }),
            Tt("borderWidth", {
            ...
            parser: function (t, e, i, n, r, o) {
              ...
              return (
                ...
                V
                  ...
                  : (((r = new vt(l, "opacity", 100 * a, 100 * (e - a), r)).xn1 = u
                      ? 1
                      : 0),
                    (l.zoom = 1),
                    (r.type = 2),
          ...
          Tt("className", {
            parser: function (t, e, n, r, o, a, l) {
              var u,
                ...
                g = t.style.cssText;
              if (
                (((o = r._classNamePT = new vt(t, n, 0, 0, o, 2)).setRatio = $t),
                (o.pr = -11),
                (i = !0),
                (o.b = d),
                (h = et(t, s)),
          ...
          for (
            Tt("clearProps", {
              parser: function (t, e, n, s, r) {
                return (
                  ((r = new vt(t, n, 0, 0, r, 2)).setRatio = Zt),
                  (r.e = e),
                  (r.pr = -10),
                  (r.data = s._tween),
                  (i = !0),
          ...
          ((u = o.prototype)._firstPT = u._lastParsedTransform = u._transform = null),
            (u._onInitTween = function (t, e, a) {
              ...
              if (i) {
                for (; f; ) {
                  for (v = f._next, g = m; g && g.pr > f.pr; ) g = g._next;
                      ...
                      (m && C.test(f))
                        ? (m ||
                            (f =
                              ...
                              f.join(",") +
                              ")"),
                          (i = bt(v, o, p, f, !0, "transparent", i, 0, r)))
                        : m && I.test(f)
                        ? (i = bt(v, o, p, f, !0, null, i, 0, r))
                        : ((d =
                            (u = parseFloat(p)) || 0 === u
                              ? p.substr((u + "").length)
                              : ""),
                          ...
                          (_ = m && "=" === f.charAt(1))
                            ? ((c = parseInt(f.charAt(0) + "1", 10)),
                              ...
                              (c *= parseFloat(f)),
                              (g = f.replace(x, "")))
                            : ((c = parseFloat(f)), (g = m ? f.replace(x, "") : "")),
                          "" === g && (g = o in n ? n[o] : d),
          ...
          var Kt = function (t, e, i) {
            var n, s, r, o;
            if (t.slice) for (s = t.length; --s > -1; ) Kt(t[s], e, i);
            else
      ...
      ((i = t.prototype)._onInitAllProps = function () {
        for (
          var t,
            ...
            n,
            s = this._tween,
            r = s.vars.roundProps.join ? s.vars.roundProps : s.vars.roundProps.split(","),
            o = r.length,
            a = {},
              ...
              a.length &&
                ...
                -1 !== s.indexOf("_cw") && 0 > o
                  ...
                  : -1 !== s.indexOf("ccw") &&
                    ...
                    (o = ((o - 9999999999 * l) % l) - ((o / l) | 0) * l)),
              (o > 1e-6 || -1e-6 > o) &&
                (this._addTween(t, n, r, r + o, n), this._overwriteProps.push(n)));
          return !0;
        },
        set: function (t) {
          var e;
    ...
    if (!s.TweenLite) {
        ...
        g =
          ...
          function (t) {
            return (
              null != t &&
              (t instanceof Array ||
                ("object" == typeof t && !!t.push && i.call(t) === n))
            );
          }),
        m = {},
        _ = function (e, i, n, r) {
      ...
      ((a = S.prototype).addEventListener = function (t, e, i, n, s) {
        ...
        for (null == a && (this._listeners[t] = a = []), o = a.length; --o > -1; )
          (r = a[o]).c === e && r.s === i
            ? a.splice(o, 1)
            : 0 === h && r.pr < s && (h = o + 1);
        a.splice(h, 0, { c: e, s: i, up: n, pr: s }), this !== l || u || l.wake();
      }),
        (a.removeEventListener = function (t, e) {
          var i,
            n = this._listeners[t];
          if (n)
            for (i = n.length; --i > -1; ) if (n[i].c === e) return void n.splice(i, 1);
        }),
        (a.dispatchEvent = function (t) {
          ...
          if (s)
            for (e = s.length, i = this._eventTarget; --e > -1; )
              (n = s[e]) &&
                (n.up ? n.c.call(n.s || i, { type: t, target: i }) : n.c.call(n.s || i));
        });
      ...
      for (o = (r = ["ms", "moz", "webkit", "o"]).length; --o > -1 && !C; )
        (C = t[r[o] + "RequestAnimationFrame"]),
          (A =
            t[r[o] + "CancelAnimationFrame"] || t[r[o] + "CancelRequestAnimationFrame"]);
      y("Ticker", function (t, e) {
        ...
        S.call(a),
          ...
          (a.sleep = function () {
            null != s &&
              (c && A ? A(s) : clearTimeout(s), (n = d), (s = null), a === l && (u = !1));
          }),
          (a.wake = function (t) {
            null !== s
              ? a.sleep()
          ...
          (a.fps = function (t) {
            return arguments.length
              ? ((r = 1 / ((i = t) || 60)), (o = this.time + r), void a.wake())
              : i;
          }),
          (a.useRAF = function (t) {
            return arguments.length ? (a.sleep(), (c = t), void a.fps(i)) : c;
          }),
          a.fps(t),
          setTimeout(function () {
            "auto" === c &&
      ...
      (l = k.ticker = new c.Ticker()),
        ...
        (a._paused = !1);
      var L = function () {
        u && O() - E > 2e3 && l.wake(), setTimeout(L, 2e3);
      };
      L(),
        (a.play = function (t, e) {
          ...
          if (this._timeline) {
            ...
            this._gc && this._enabled(!0, !1),
              (this._totalTime !== t || 0 === this._duration) &&
                (I.length && Z(), this.render(t, e, !1), I.length && Z());
          }
          return this;
        }),
      ...
      var M = y(
          "TweenLite",
          function (e, i, n) {
            if ((k.call(this, i, n), (this.render = M.prototype.render), null == e))
            ...
            if (
              ((this._overwrite = l =
                null == l ? U[M.defaultOverwrite] : "number" == typeof l ? l >> 0 : U[l]),
                ...
                (r = o[s])
                  ? "string" != typeof r
                    ? r.length &&
                      ...
                      ? (o.splice(s--, 1), (this._targets = o = o.concat(f(r))))
                      : ((this._siblings[s] = Q(r, this, !1)),
                        1 === l &&
                          this._siblings[s].length > 1 &&
                          J(r, this, null, 1, this._siblings[s]))
                    : "string" == typeof (r = o[s--] = M.selector(r)) &&
                      o.splice(s + 1, 1)
                  : o.splice(s--, 1);
            else
              (this._propLookup = {}),
        ...
        B = function (t, e, i, n) {
          ...
          for (
            ...
            (h = r[a]),
              ...
              (p += h.length);
          return (f += e.substr(p)) && c.push(f), (c.setRatio = F), c;
        },
          ...
          return (
            "number" !== h &&
              ...
              "string" == typeof u && (o || isNaN(u))
                ...
                : c || ((p.s = parseFloat(u)), (p.c = parseFloat(n) - p.s || 0))),
            p.c
              ? ((p._next = this._firstPT) && (p._next._prev = p), (this._firstPT = p), p)
              : void 0
          );
        },
        Y = (M._internals = { isArray: g, isSelector: D, lazyTweens: I, blobDif: B }),
        j = (M._plugins = {}),
        H = (Y.tweenLookup = {}),
        q = 0,
        V = (Y.reservedProps = {
        ...
        (k._updateRoot = M.render =
          function () {
            ...
            if (
              ...
              for (i in (($ = l.frame + (parseInt(M.autoSleep, 10) || 120)), H)) {
      ...
      var Q = function (t, e, i) {
          var n,
            ...
            r = t._gsTweenID;
          if (
            (H[r || (t._gsTweenID = r = "t" + q++)] || (H[r] = { target: t, tweens: [] }),
          ...
          for (r = s.length; --r > -1; )
            (a = s[r]) === e ||
              ...
              (a._timeline !== e._timeline
                ? ((u = u || tt(e, 0, d)), 0 === tt(a, u, d) && (c[f++] = a))
                : a._startTime <= h &&
                  a._startTime + a.totalDuration() / a._timeScale > h &&
                  (((d || !a._initted) && h - a._startTime <= 2e-10) || (c[f++] = a)));
          for (r = f; --r > -1; )
            if (
              ((a = c[r]),
        ...
        tt = function (t, e, i) {
          ...
          return (r /= s) > e
            ? r - e
            : (i && r === e) || (!t._initted && 2 * p > r - e)
            ? p
            : (r += t.totalDuration() / t._timeScale / s) > e + p
            ? 0
            : r - e - p;
        };
      (a._init = function () {
        ...
        (a._initProps = function (e, i, n, s) {
          ...
          this.vars))
            if (((h = this.vars[r]), V[r]))
              h &&
                (h instanceof Array || (h.push && g(h))) &&
          ...
          if (t >= l - 1e-7)
            ...
            (1 === c || (3 === c && h >= 0.5)) && (h = 1 - h),
              ...
              1 === f
                ...
                : 4 === f && (h *= h * h * h * h),
              (this.ratio =
                1 === c ? 1 - h : 2 === c ? h : 0.5 > t / l ? h / 2 : 1 - h / 2);
          ...
          if (this._time !== a || i) {
            ...
            for (
              ...
              r.f
                ...
                (r = r._next);
            this._onUpdate &&
              (0 > t && this._startAt && -1e-4 !== t && this._startAt.render(t, e, i),
        ...
        (a._kill = function (t, e, i) {
          ...
          e =
            "string" != typeof e ? e || this._targets || this.target : M.selector(e) || e;
          var n,
            s,
            r,
            o,
      ...
      if (
        ...
        for (a in m)
          m[a].func ||
            t.console.log("GSAP encountered missing dependency: com.greensock." + a);
      }
      u = !1;
    }
  })(
    ...
    _gsScope._gsDefine(
      ...
      function (t, e, i) {
        var n,
          ...
          N = 0,
          z = -1 !== navigator.userAgent.toLowerCase().indexOf("android"),
          F = 0,
          B = {},
          X = {},
          Y = function () {
          ...
          j = function (t) {
            ...
            e.to(H, 0, { overwrite: "all", delay: 15, onComplete: H });
          },
          H = function () {
          ...
          q = function () {
            return null != window.pageYOffset
              ...
              : null != x.scrollTop
              ? x.scrollTop
              : T.scrollTop || x.body.scrollTop || 0;
          },
          V = function () {
            return null != window.pageXOffset
              ...
              : null != x.scrollLeft
              ? x.scrollLeft
              : T.scrollLeft || x.body.scrollLeft || 0;
          },
          U = function (t, e) {
            kt(t, "scroll", e), W(t.parentNode) || U(t.parentNode, e);
          },
          G = function (t, e) {
            Lt(t, "scroll", e), W(t.parentNode) || G(t.parentNode, e);
          },
          W = function (t) {
            return !(
              t &&
          ...
          $ = function (t, e) {
            ...
            return Math.max(
              0,
              W(t)
                ? Math.max(T[n], r[n]) - (window["inner" + i] || T[s] || r[s])
                : t[n] - t[s]
            );
          },
          Z = function (t) {
            ...
            return t
              ? ("string" == typeof t && (t = e.selector(t)),
                t.length &&
                  ...
                  !t.nodeType &&
                  (t = t[0]),
                t === window || (t.nodeType && t.style) ? t : null)
              : t;
          },
          J = function (t, e) {
            var i,
          ...
          et = x.defaultView ? x.defaultView.getComputedStyle : A,
              ...
              "%" === n && -1 !== e.indexOf("border")
                ...
                : ((l.cssText =
                  ...
                  "%" !== n && a.appendChild
                    ...
                    : ((a = t.parentNode || x.body), (l[o ? "width" : "height"] = i + n)),
                  a.appendChild(S),
              ...
              : (t.style[e]
                ...
                "auto" !== s ||
                  ...
                  (s = (function (t, e) {
                    ...
                    return (
                      t["offset" + i] -
                      (st(t, e, parseFloat(n), (n + "").replace(nt, "")) || 0)
                    );
                  })(t, e)),
                i ? s : parseFloat(s) || 0);
          },
          ...
          lt = function () {
            if (!x.createElementNS) return (r = 0), void (o = !1);
            var t,
              e,
              i,
              n,
              s = P("div"),
              h = x.createElementNS("http://www.w3.org/2000/svg", "svg"),
              c = P("div"),
              p = s.style,
              f = x.body || T;
            x.body &&
              ...
              (t = h.getScreenCTM()),
              0 === e && 0 === t.e && 0 === t.f && 1 === t.a
                ? ((r = 1), (o = !0))
                : ((r = e !== t.e ? 1 : 0), (o = 1 !== t.a)),
              f.removeChild(h);
          },
          ut = "" !== J(S, "perspective"),
          ht = J(S, "transformOrigin")
            .replace(/^ms/g, "Ms")
            .replace(/([A-Z])/g, "-$1")
            .toLowerCase(),
          ct = J(S, "transform"),
          ...
          bt = function (t) {
            ...
            if (
              !1 !== Ft.cacheSVGData &&
              t._gsCache &&
              t._gsCache.lastUpdate === e.ticker.frame
            )
              return t._gsCache;
            var i,
              n,
            ...
            if (((v.lastUpdate = e.ticker.frame), t.getBBox && !v.isSVGRoot)) {
              for (
                _ = t.parentNode, i = t.getBBox();
                _ && "svg" !== (_.nodeName + "").toLowerCase();
            ...
            for (
              (s = v.offsetParent) === x.body && (s = T), yt.length = vt.length = 0;
              _ &&
              ("matrix(1, 0, 0, 1, 0, 0)" !== (u = rt(_, ct, !0)) &&
                "none" !== u &&
                "translate3d(0px, 0px, 0px)" !== u &&
                (yt.push(_), vt.push(_.style[ct]), (_.style[ct] = "none")),
              _ !== s);
            ...
            for (
              n = s.getBoundingClientRect(),
                ...
                v.borderBox &&
                  ...
                  ((l = et(t) || {}),
                  (f =
                    parseFloat(l.borderLeftWidth) + parseFloat(l.borderRightWidth) || 0),
                  (d =
                    parseFloat(l.borderTopWidth) + parseFloat(l.borderBottomWidth) || 0),
                ...
                a
                  ? ((i = t.getBoundingClientRect()),
                    ...
                    (v.offsetTop = i.top - n.top))
                  : ((v.offsetLeft = c.x - n.left), (v.offsetTop = c.y - n.top)),
                v.offsetParent = s,
                h = yt.length;
              --h > -1;
          ...
          wt = function (t, i) {
            if (((i = i || {}), !t || t === T || !t.parentNode || t === window))
              return { x: 0, y: 0 };
            var n = et(t),
            ...
            return (
              ...
              t.getBBox && mt(t)
                ? (t._gsTransform ||
                    (e.set(t, { x: "+=0", overwrite: !1 }), t._gsTransform.xOrigin),
                  (s = t.getBBox()),
                  (i.x = t._gsTransform.xOrigin - s.x),
                  (i.y = t._gsTransform.yOrigin - s.y))
                : (t.getBBox &&
                    -1 !== (o + a).indexOf("%") &&
                    (t = {
                  ...
                  (i.x =
                    -1 !== o.indexOf("%")
                      ? (t.offsetWidth * parseFloat(o)) / 100
                      : parseFloat(o)),
                  (i.y =
                    -1 !== a.indexOf("%")
                      ? (t.offsetHeight * parseFloat(a)) / 100
                      : parseFloat(a))),
              i
            );
          },
          ...
          Tt = function (t, e, i, n) {
            ...
            var s,
              ...
              S = P._gsCache || xt(P),
              C = w.computedStyle,
              A = w.isSVG ? S.offsetParent : P.offsetParent;
            return (
              (s =
                w.isSVG && -1 !== (t.style[ct] + "").indexOf("matrix")
                  ? t.style[ct]
                  : C
                  ? C.getPropertyValue(pt)
                  : t.currentStyle
                  ? t.currentStyle[ct]
                  : "1,0,0,1,0,0"),
              t.getBBox &&
                -1 !== (t.getAttribute("transform") + "").indexOf("matrix") &&
                (s = t.getAttribute("transform")),
              (s = (s + "").match(/(?:\-|\.|\b)(\d|\.|e\-)+/g) || [1, 0, 0, 1, 0, 0])
                .length > 6 && (s = [s[0], s[1], s[4], s[5], s[12], s[13]]),
              n
                ? (s[4] = s[5] = 0)
                : w.isSVG &&
                  (c = t._gsTransform) &&
                  ...
                  (s[4] =
                    parseFloat(s[4]) -
                    (c.xOrigin - (c.xOrigin * s[0] + c.yOrigin * s[2]))),
                  (s[5] =
                    parseFloat(s[5]) -
                    (c.yOrigin - (c.xOrigin * s[1] + c.yOrigin * s[3])))),
              e &&
                (void 0 === r && lt(),
                (a = w.isSVG || w.isSVGRoot ? bt(t) : t),
                w.isSVG
                  ? ((h = t.getBBox()),
                    (m = S.isSVGRoot ? { x: 0, y: 0 } : P.getBBox()),
                    (a = {
                      offsetLeft: h.x - m.x,
                      offsetTop: h.y - m.y,
                  ...
                  : w.isSVGRoot
                  ? ((_ = parseInt(C.borderTopWidth, 10) || 0),
                  ...
                  : !l &&
                    t.offsetParent &&
                    ((e.x += parseInt(rt(t.offsetParent, "borderLeftWidth"), 10) || 0),
                ...
                (s[5] =
                  ...
                  i.y -
                  (o ? 0 : P.scrollTop || 0)),
                P && "fixed" === rt(t, "position", C) && ((s[4] += V()), (s[5] += q())),
                !P ||
                  P === T ||
                  A !== a.offsetParent ||
                  S.isSVG ||
                  (u && "100100" !== Tt(P).join("")) ||
                  ((a = S.isSVGRoot ? bt(P) : P),
                  (s[4] -= a.offsetLeft || 0),
                  (s[5] -= a.offsetTop || 0),
                  l ||
                    !S.offsetParent ||
                    w.isSVG ||
                    w.isSVGRoot ||
                    ((s[4] -= parseInt(rt(S.offsetParent, "borderLeftWidth"), 10) || 0),
          ...
          Pt = function (t, e) {
            ...
            for (
              var i,
                ...
                u,
                h = wt(t, ft),
                c = wt(t.parentNode, dt),
                p = Tt(t, h, c);
              (t = t.parentNode) && t.parentNode && t !== T;
          ...
          St = function (t, e, i) {
            ...
            return (
              (t.x = n * i[0] + s * i[2] + i[4]), (t.y = n * i[1] + s * i[3] + i[5]), t
            );
          },
          Ct = function (t, e, i) {
            ...
            if (t === window)
              (o = q()),
                (r =
                  (s = V()) + (T.clientWidth || t.innerWidth || x.body.clientWidth || 0)),
                (a =
                  o +
                  ((t.innerHeight || 0) - 20 < T.clientHeight
                    ? T.clientHeight
                    : t.innerHeight || x.body.clientHeight || 0));
            else {
              if (void 0 === e || e === window) return t.getBoundingClientRect();
              (s = -(n = wt(t)).x),
                (o = -n.y),
                A
                  ? ((g = (d = t.getBBox()).width), (m = d.height))
                  : "svg" !== (t.nodeName + "").toLowerCase() && t.offsetWidth
                  ? ((g = t.offsetWidth), (m = t.offsetHeight))
                  : ((S = et(t)), (g = parseFloat(S.width)), (m = parseFloat(S.height))),
                (r = s + g),
                (a = o + m),
                "svg" !== t.nodeName.toLowerCase() ||
                  k ||
                  ((C = (_ = bt(t)).computedStyle || {}),
                  ...
                  (o -= y / _.scaleY - P),
                  S &&
                    ((r += (parseFloat(C.borderRightWidth) + v) / _.scaleX),
                    (a += (y + parseFloat(C.borderBottomWidth)) / _.scaleY)));
            }
            return t === e
              ? { left: s, top: o, width: r - s, height: a - o }
              : ((l = Pt(t)),
                (u = Pt(e, !0)),
                (h = St({ x: s, y: o }, l, u)),
                (c = St({ x: r, y: o }, l, u)),
          ...
          At = function (t) {
            return !!(
              ...
              t.length &&
              t[0] &&
              ((t[0].nodeType && t[0].style && !t.nodeType) || (t[0].length && t[0][0]))
            );
          },
          Ot = "ontouchstart" in T && "orientation" in window,
          Et = (function (t) {
            for (
              var e = t.split(","),
                i = (
                  void 0 !== S.onpointerdown
                    ? "pointerdown,pointermove,pointerup,pointercancel"
                    : void 0 !== S.onmspointerdown
          ...
          kt = function (t, e, i, n) {
            t.addEventListener
              ? t.addEventListener(Et[e] || e, i, n)
              : t.attachEvent && t.attachEvent("on" + e, i);
          },
          Lt = function (t, e, i) {
            t.removeEventListener
              ? t.removeEventListener(Et[e] || e, i)
              : t.detachEvent && t.detachEvent("on" + e, i);
          },
          Rt = function (t) {
            (n = t.touches && N < t.touches.length), Lt(t.target, "touchend", Rt);
          },
          Mt = function (t) {
            (n = t.touches && N < t.touches.length), kt(t.target, "touchend", Rt);
          },
          Dt = function (t, e, i, n, s, r) {
            ...
            if (e)
              if (1 !== s && e instanceof Array) {
                for (u.end = o = [], l = e.length, a = 0; l > a; a++) o[a] = e[a] * s;
                (i += 1.1), (n -= 1.1);
              } else
                u.end =
                  "function" == typeof e
          ...
          Ft = function (r, o) {
            ...
            var a,
              ...
              gt,
              mt,
              _t = (o.type || (k ? "top,left" : "x,y")).toLowerCase(),
              vt = -1 !== _t.indexOf("x") || -1 !== _t.indexOf("y"),
              yt = -1 !== _t.indexOf("rotation"),
              bt = yt ? "rotation" : vt ? "x" : "left",
              xt = vt ? "y" : "top",
              Tt = -1 !== _t.indexOf("x") || -1 !== _t.indexOf("left") || "scroll" === _t,
              St = -1 !== _t.indexOf("y") || -1 !== _t.indexOf("top") || "scroll" === _t,
              Ct = o.minimumMovement || 2,
              At = this,
              Rt = (function (t) {
                if (("string" == typeof t && (t = e.selector(t)), !t || t.nodeType))
                  return [t];
                var i,
                  n = [],
                  s = t.length;
                ...
                return n;
              })(o.trigger || o.handle || r),
              Bt = {},
              Xt = 0,
              jt = !1,
              Ht = o.clickableTest || It,
              qt = 0,
              Vt = function (t) {
                if (At.autoScroll && At.isDragging && (jt || $)) {
                  ...
                  for (
                    ...
                    (e = (i = W(c.parentNode)) ? X : c.parentNode),
                      ...
                      (a = u = 0),
                      St &&
                        (0 > (h = e._gsMaxScrollY - e.scrollTop)
                          ? (u = h)
                          : o > n.bottom - 40 && h
                          ? ((jt = !0),
                            (u = Math.min(
                              h,
                              (p * (1 - Math.max(0, n.bottom - o) / 40)) | 0
                            )))
                          : o < n.top + 40 &&
                            e.scrollTop &&
                            ((jt = !0),
                            (u = -Math.min(
                              e.scrollTop,
                              (p * (1 - Math.max(0, o - n.top) / 40)) | 0
                            ))),
                        u && (e.scrollTop += u)),
                      Tt &&
                        (0 > (h = e._gsMaxScrollX - e.scrollLeft)
                          ? (a = h)
                          : s > n.right - 40 && h
                          ? ((jt = !0),
                            (a = Math.min(
                              h,
                              (p * (1 - Math.max(0, n.right - s) / 40)) | 0
                            )))
                          : s < n.left + 40 &&
                            e.scrollLeft &&
                            ((jt = !0),
                ...
                if ($) {
                  ...
                  1e-6 > f && f > -1e-6 && (f = 0),
                    1e-6 > d && d > -1e-6 && (d = 0),
                    yt
                      ? ((pt.data.rotation = At.rotation = f), pt.setRatio(1))
                      : l
                      ? (St && l.top(d), Tt && l.left(f))
                      : vt
                      ? (St && (pt.data.y = d), Tt && (pt.data.x = f), pt.setRatio(1))
                      : (St && (r.style.top = d + "px"), Tt && (r.style.left = f + "px")),
                    !g || t || gt || ((gt = !0), ot(At, "drag", "onDrag"), (gt = !1));
                }
                $ = !1;
              },
              Ut = function (t, i) {
                var n,
                  s = At.x,
                  o = At.y;
                r._gsTransform || (!vt && !yt) || e.set(r, { x: "+=0", overwrite: !1 }),
                  vt
                    ? ((At.y = r._gsTransform.y), (At.x = r._gsTransform.x))
                    : yt
                    ? (At.x = At.rotation = r._gsTransform.rotation)
                    : l
                    ? ((At.y = l.top()), (At.x = l.left()))
                    : ((At.y = parseInt(r.style.top, 10) || 0),
                      (At.x = parseInt(r.style.left, 10) || 0)),
                  (!et && !it) ||
                    i ||
                    (et &&
                      (n = et(At.x)) !== At.x &&
                      ((At.x = n), yt && (At.rotation = n)),
                ...
                (d = !1),
                  l
                    ? (l.calibrate(),
                      ...
                      (d = !0))
                    : o.bounds &&
                      ((t = at(o.bounds, r.parentNode)),
                      yt
                        ? ((At.minX = P = t.left),
                          (At.maxX = w = t.left + t.width),
                          (At.minY = A = At.maxY = S = 0))
                      ...
                      P > w && ((At.minX = w), (At.maxX = w = P), (P = At.minX)),
                      A > S && ((At.minY = S), (At.maxY = S = A), (A = At.minY)),
                      yt && ((At.minRotation = P), (At.maxRotation = w)),
                      (d = !0)),
                  o.liveSnap &&
                    ((n =
                      (i = !0 === o.liveSnap ? o.snap || {} : o.liveSnap) instanceof
                        Array || "function" == typeof i),
                    yt
                      ? ((et = te(n ? i : i.rotation, P, w, 1)), (it = null))
                      : (Tt &&
                          (et = te(
                            n ? i : i.x || i.left || i.scrollLeft,
                            P,
                            w,
                            l ? -1 : 1
                          )),
              ...
              Wt = function () {
                (At.isThrowing = !1), ot(At, "throwcomplete", "onThrowComplete");
              },
              $t = function () {
                At.isThrowing = !1;
              },
              Zt = function (t, e) {
                ...
                t && s
                  ? (!0 === t &&
                      ((n =
                        (i = o.snap || {}) instanceof Array || "function" == typeof i),
                      (t = {
                        resistance:
                          (o.throwResistance || o.resistance || 1e3) / (yt ? 10 : 1),
                      }),
                      yt
                        ? (t.rotation = Dt(At, n ? i : i.rotation, w, P, 1, e))
                        : (Tt &&
                            (t[bt] = Dt(
                              At,
                              n ? i : i.x || i.left || i.scrollLeft,
                    ...
                    (At.isThrowing = !0),
                    (u = isNaN(o.overshootTolerance)
                      ? 1 === o.edgeResistance
                        ? 0
                        : 1 - At.edgeResistance + 0.2
                      ...
                      s.to(
                        l || r,
                        {
                          ...
                          onUpdateParams: o.fastMode
                            ? [At, "onthrowupdate", "onThrowUpdate"]
                            : C,
                        },
                        isNaN(o.maxDuration) ? 2 : o.maxDuration,
                        isNaN(o.minDuration) ? (0 === u ? 0 : 0.5) : o.minDuration,
                        u
                      )),
                    o.fastMode ||
                      (l && (l._suspendTransforms = !0),
              ...
              Kt = function () {
                ...
                Qt(),
                  lt &&
                    ((u = At.pointerX * lt[0] + At.pointerY * lt[2] + lt[4]),
                    (c = At.pointerX * lt[1] + At.pointerY * lt[3] + lt[5])),
                  $ && (ne(At.pointerX, At.pointerY), Vt(!0)),
                  l
                    ? (Gt(), (f = l.top()), (p = l.left()))
                    : (Jt() ? (Ut(!0, !0), Gt()) : At.applyBounds(),
                      yt
                        ? ((V = (function (t, e, i, n, s) {
                          ...
                          (p = At.x),
                          (f = At.y =
                            Math.atan2(V.y - At.pointerY, At.pointerX - V.x) * O))
                        : ((r.parentNode && r.parentNode.scrollTop) || 0,
                          (r.parentNode && r.parentNode.scrollLeft) || 0,
                          (f = rt(r, xt)),
                          (p = rt(r, bt)))),
                  d &&
                    t &&
                    (p > w ? (p = w + (p - w) / t) : P > p && (p = P - (P - p) / t),
                    yt ||
                      (f > S ? (f = S + (f - S) / t) : A > f && (f = A - (A - f) / t)));
              },
              Jt = function () {
                  ...
                  if (
                    ((ft =
                      !(
                        ...
                        Tt === St ||
                        l ||
                        !1 === At.vars.allowNativeTouchScrolling
                      ) && (Tt ? "y" : "x")),
                    k
                      ? (t = Q(t, !0))
                      : ft ||
                        At.allowEventDefault ||
                        (t.preventDefault(),
                        t.preventManipulation && t.preventManipulation()),
                    t.changedTouches
                      ? ((t = H = t.changedTouches[0]), (q = t.identifier))
                      : t.pointerId
                      ? (q = t.pointerId)
                      : (H = q = null),
                    N++,
                    (function (t) {
                      R.push(t),
                        1 === R.length &&
                          e.ticker.addEventListener("tick", Y, this, !1, 1);
                    })(Vt),
                    ...
                    !At.autoScroll ||
                      ...
                      L.parentNode ||
                      ((L.style.width = r.parentNode.scrollWidth + "px"),
                      r.parentNode.appendChild(L)),
                    Kt(),
                    At.tween && At.tween.kill(),
                    (At.isThrowing = !1),
                    e.killTweensOf(l || r, !0, Bt),
                    l && e.killTweensOf(r, !0, { scrollTo: 1 }),
                    (At.tween = At.lockedAxis = null),
                    (o.zIndexBoost || (!yt && !l && !1 !== o.zIndexBoost)) &&
                      (r.style.zIndex = Ft.zIndex++),
                    (At.isPressed = !0),
              ...
              ie = function (t) {
                ...
                if (a && !n && At.isPressed && t) {
                  if (((At.pointerEvent = t), (e = t.changedTouches))) {
                  ...
                  if (k) t = Q(t, !0);
                    ...
                    if (
                      ...
                      (s = t.pageY),
                      lt &&
                        ((r = i * lt[0] + s * lt[2] + lt[4]),
                        (s = i * lt[1] + s * lt[3] + lt[5]),
                        (i = r)),
                      (dt = Math.abs(i - u) > Math.abs(s - c) && Tt ? "x" : "y"),
                      !1 !== At.vars.lockAxisOnTouchScroll &&
                        ((At.lockedAxis = "x" === dt ? "y" : "x"),
                        "function" == typeof At.vars.onLockAxis &&
                          At.vars.onLockAxis.call(At, o)),
                      z && ft === dt)
                    )
                      return void se(o);
                    At.allowEventDefault ||
                  ...
                  At.autoScroll && (jt = !0), ne(t.pageX, t.pageY);
                }
              },
              ne = function (t, e) {
                var i,
                  ...
                  o,
                  a,
                  l = 1 - At.dragResistance,
                  h = 1 - At.edgeResistance;
                (At.pointerX = t),
                  (At.pointerY = e),
                  yt
                    ? ((r = Math.atan2(V.y - e, t - V.x) * O),
                      (o = At.y - r),
                      (At.y = r),
                      o > 180 ? (f -= 360) : -180 > o && (f += 360),
                      (s = p + (f - r) * l))
                    : (lt &&
                        ((a = t * lt[0] + e * lt[2] + lt[4]),
                        (e = t * lt[1] + e * lt[3] + lt[5]),
                        (t = a)),
                      Ct > (n = e - c) && n > -Ct && (n = 0),
                      Ct > (i = t - u) && i > -Ct && (i = 0),
                      (At.lockAxis || At.lockedAxis) &&
                        (i || n) &&
                        ((a = At.lockedAxis) ||
                          ((At.lockedAxis = a =
                            Tt && Math.abs(i) > Math.abs(n) ? "y" : St ? "x" : null),
                          a &&
                            "function" == typeof At.vars.onLockAxis &&
                            At.vars.onLockAxis.call(At, At.pointerEvent)),
                        "y" === a ? (n = 0) : "x" === a && (i = 0)),
                      (s = p + i * l),
                      (r = f + n * l)),
                  et || it
                    ? (et && (s = et(s)), it && (r = it(r)))
                    : d &&
                      (s > w ? (s = w + (s - w) * h) : P > s && (s = P + (s - P) * h),
                      yt ||
                        (r > S ? (r = S + (r - S) * h) : A > r && (r = A + (r - A) * h))),
                  yt || ((s = Math.round(s)), (r = Math.round(r))),
                  (At.x !== s || (At.y !== r && !yt)) &&
                    (yt
                      ? (At.endRotation = At.x = At.endX = s)
                      : (St && (At.y = At.endY = r), Tt && (At.x = At.endX = s)),
                    ($ = !0),
                    !At.isDragging &&
                      At.isPressed &&
                      ((At.isDragging = !0), ot(At, "dragstart", "onDragStart")));
              },
              se = function (t, i) {
                if (
                  a &&
                  ...
                  if ((c && ((Xt = F = E()), (At.isDragging = !1)), N--, t)) {
                    if (
                      (k && (t = Q(t, !1)),
                  ...
                  return (
                    h && !c
                      ? (ht && (o.snap || o.bounds) && Zt(o.throwProps),
                        ot(At, "release", "onRelease"),
                        (z && "touchmove" === h.type) ||
                          (ot(At, "click", "onClick"),
                          ...
                          e.delayedCall(1e-5, function () {
                            qt !== mt &&
                              ...
                              (u.click
                                ? u.click()
                                : x.createEvent &&
                                  ((l = x.createEvent("MouseEvents")).initMouseEvent(
                                    "click",
                                    !0,
                                    !0,
                                    window,
                                    1,
                                    At.pointerEvent.screenX,
                                    At.pointerEvent.screenY,
                                    At.pointerX,
                                    At.pointerY,
                                    !1,
                                    !1,
                      ...
                      : (Zt(o.throwProps),
                        k ||
                          At.allowEventDefault ||
                          !h ||
                          (!o.dragClickables && Ht.call(At, h.target)) ||
                          !c ||
                          (ft && (!dt || ft !== dt)) ||
                          !1 === h.cancelable ||
                          (h.preventDefault(),
              ...
              re = function (t) {
                if (t && At.isDragging) {
                  ...
                  (i || n) &&
                    (lt
                      ? ((u -= i * lt[0] + n * lt[2]), (c -= n * lt[3] + i * lt[1]))
                      : ((u -= i), (c -= n)),
                    (e._gsScrollX += i),
                    (e._gsScrollY += n),
              ...
              oe = function (t) {
                ...
                return i && mt !== qt
                  ...
                  : void (
                      ...
                      (t.preventDefault
                        ? (t.preventDefault(),
                          (i || (n && !1 !== At.vars.suppressClickOnDrag)) &&
            ...
            (J = Ft.get(this.target)) && J.kill(),
                ...
                var i,
                  ...
                  u =
                    "velocity" === t && s
                      ...
                      : "element";
                return (
                  "element" === u && ((a = Yt(At.target)), (l = Yt(t))),
                  (i =
                    "start" === u
                      ? At.x - p
                      : "velocity" === u
                      ? s.getVelocity(this.target, bt)
                  ...
                  if (
                    ...
                    for (
                      ...
                      (a = (l = W(s.parentNode)) ? X : s.parentNode),
                        ...
                        (s = a);
                  At.isThrowing &&
                    (n || At.endX > w || At.endX < P || At.endY > S || At.endY < A) &&
                    Zt(o.throwProps, n);
                }
                return At;
              }),
              (this.update = function (t, e) {
                ...
                return (
                  Qt(),
                  t ? At.applyBounds() : ($ && e && Vt(!0), Ut(!0)),
                  At.isPressed &&
                    ((Tt && Math.abs(i - At.x) > 0.01) ||
                      (St && Math.abs(n - At.y) > 0.01 && !yt)) &&
                    Kt(),
                  At.autoScroll && (Z(r.parentNode), (jt = At.isDragging), Vt(!0)),
                  At.autoScroll && (G(r, re), U(r, re)),
                  At
                );
              }),
              (this.enable = function (t) {
                ...
                return (
                  ...
                  s &&
                    "soft" !== t &&
                    s.track(l || r, vt ? "x,y" : yt ? "rotation" : "top,left"),
                  l && l.enable(),
                  (r._gsDragID = n = "d" + D++),
                  (M[n] = this),
                  l && (l.element._gsDragID = n),
                  e.set(r, { x: "+=0", overwrite: !1 }),
                  (pt = {
                    t: r,
                    ...
                    setRatio: k
                      ...
                      : i._internals.setTransformRatio ||
                        i._internals.set3DTransformRatio,
                  }),
                  At.update(!0),
                  At
                );
              ...
              (this.disable = function (t) {
                var e,
                  i,
                  n = At.isDragging;
                if (!yt) for (e = Rt.length; --e > -1; ) tt(Rt[e], "cursor", null);
                if ("soft" !== t) {
                  for (e = Rt.length; --e > -1; )
                    (i = Rt[e]),
                ...
                return (
                  ...
                  s &&
                    "soft" !== t &&
                    s.untrack(l || r, vt ? "x,y" : yt ? "rotation" : "top,left"),
                  l && l.disable(),
                  j(Vt),
              ...
              -1 !== _t.indexOf("scroll") &&
                  ...
                  new (function (t, i) {
                    ...
                    ut && !1 !== i.force3D
                      ...
                      (this.left = function (n, s) {
                        ...
                        return (r > 2 || -2 > r) && !s
                          ? ((m = t.scrollLeft),
                            e.killTweensOf(this, !0, { left: 1, scrollLeft: 1 }),
                            this.left(-m),
                      ...
                      (this.top = function (n, s) {
                        ...
                        return (r > 2 || -2 > r) && !s
                          ? ((g = t.scrollTop),
                            e.killTweensOf(this, !0, { top: 1, scrollTop: 1 }),
                            this.top(-g),
                            void (i.onKill && i.onKill()))
                          : (0 > (n = -n)
                              ? ((f = (n - 0.5) | 0), (n = 0))
                      ...
                      (this.disable = function () {
                        for (p = u.firstChild; p; )
                          (o = p.nextSibling), t.appendChild(p), (p = o);
                        ...
                        (g = t.scrollTop),
                          ...
                          (!a ||
                            ...
                            (!a || e) &&
                              ...
                              (c.width = "auto"),
                              (c.paddingRight = "0px"),
                              (y = Math.max(0, t.scrollWidth - t.clientWidth)) &&
                                (y +=
                                  rt(t, "paddingLeft") +
                                  (h ? rt(t, "paddingRight") : 0))),
                ...
                (r = l.content)),
              !1 !== o.force3D && e.set(r, { force3D: !0 }),
              yt ? (Bt.rotation = 1) : (Tt && (Bt[bt] = 1), St && (Bt[xt] = 1)),
              yt
                ? ((B = (I = y).css), (I.overwrite = !1))
                : vt && ((B = (I = Tt && St ? m : Tt ? _ : v).css), (I.overwrite = !1)),
              this.enable();
          },
          ...
          Yt = function (t, e) {
            if (t === window)
              return (
                (Xt.left = Xt.top = 0),
                (Xt.width = Xt.right =
                  T.clientWidth || t.innerWidth || x.body.clientWidth || 0),
                (Xt.height = Xt.bottom =
                  (t.innerHeight || 0) - 20 < T.clientHeight
                    ? T.clientHeight
                    : t.innerHeight || x.body.clientHeight || 0),
                ...
                ? k
                  ? (function (t) {
                      var e,
                        ...
                        n = 0,
                        s = 0;
                      for (e = (t = K(t)).offsetWidth, i = t.offsetHeight; t; )
                        (n += t.offsetTop), (s += t.offsetLeft), (t = t.offsetParent);
                      return { top: n, left: s, width: e, height: i };
                    })(t)
            ...
            return l || !i
              ...
              : ((r = -1 !== (i + "").indexOf("%")),
                ...
                !(n.width < 0 || n.height < 0) &&
                  (r
                    ? ((i *= 0.01),
                      (s = n.width * n.height) >= o.width * o.height * i ||
                        s >= a.width * a.height * i)
  ...
  (window.lazySizes = (function () {
    ...
    if (Date.now && window.document.getElementsByClassName && Object.freeze) {
      var t,
        ...
        T = /^img$/i,
        P = 10,
        S = /rident|hrome/.test(navigator.userAgent || ""),
        C = window.setImmediate || window.setTimeout,
        A = function (t, e, i) {
          var n = i ? "addEventListener" : "removeEventListener";
          t[n]("load", e, !1), t[n]("error", e, !1);
        },
        O = function (t) {
          A(t.target, O), V(t.target, !0);
        },
        E = function (t, e, i) {
          var n = b.createEvent("Event");
          return n.initEvent(e, !0, !0), (n.details = i || {}), t.dispatchEvent(n), n;
        };
      b.documentElement.classList
        ? ((a = function (t, e) {
            t.classList.add(e);
          }),
          (l = function (t, e) {
      ...
      var k,
        ...
        F =
          ...
          (M = function () {
            clearTimeout(k), (o = 0), clearTimeout(r), B(), setTimeout(R);
          }),
          {
            debounce: function () {
              clearTimeout(k), clearTimeout(void 0), (L = !0), (k = setTimeout(M, 66));
            },
            throttled: function () {
              var t;
              L ||
        ...
        B = function () {
          var e, n, s, a;
          if (((c = t.length), (N = Date.now()), c)) {
            for (
              f = window.innerWidth + P, d = window.innerHeight + P, y = -1 * P;
              o < c;
              o++
            )
              if (
                ...
                !s &&
                  ...
                  i.preloadAfterLoad &&
                  w < 2 &&
                  (v || _ || m || g || "auto" != t[o].getAttribute(i.sizesAttr)) &&
                  (n = t[o]);
              }
            n &&
              !s &&
        ...
        X =
          ...
          function () {
            clearTimeout(D), clearTimeout(n), (D = setTimeout(I, 99));
          }),
        Y = function () {
          var t,
            i,
            ...
            o = e.length;
          if (o)
            for (i = Date.now(), t = (r = s || 0) + 3, U(); r < o; r++)
              if ((G(e[r]), r > t && r < o - 1 && Date.now() - i > 9)) {
                (s = r + 1), (n = setTimeout(Y, 4));
                break;
              }
        },
        j = function () {
        ...
        H = function () {
          ...
          i.mutation &&
            (window.MutationObserver
              ? new MutationObserver(F.throttled).observe(t, {
                  childList: !0,
                  subtree: !0,
                  attributes: !0,
                })
            ...
            "onmozfullscreenchange" in t
              ? window.addEventListener("mozfullscreenchange", F.throttled, !0)
              : "onwebkitfullscreenchange" in t
              ? window.addEventListener("webkitfullscreenchange", F.throttled, !0)
              : window.addEventListener("fullscreenchange", F.throttled, !0),
            i.cssanimation &&
              (b.addEventListener("animationstart", F.throttled, !0),
              b.addEventListener("transitionstart", F.throttled, !0));
        };
      return (
        (i = window.lazySizesConfig || {}),
        (function () {
          var t,
            e = {
              clearSrcAttr: !0,
    ...
    function q(t, e) {
      var i;
      window.picturefill
        ? picturefill({ reevaluate: !0, reparse: !0, elements: [t] })
        : window.respimage && !respimage._.observer
        ? (e && (i = t[respimage._.ns]) && (i[e.srcset ? "srcset" : "src"] = void 0),
          respimage({ reparse: !0, elements: [t] }))
    ...
    function V(t, e) {
      var n,
        ...
        p,
        f,
        d = E(t, "lazybeforeunveil", { force: !!e });
      if (!d.defaultPrevented) {
        if (
          ((u = t.getAttribute(i.sizesAttr) || t.getAttribute("sizes")),
          T.test(t.nodeName || "") &&
            ((p = t.parentNode),
            (f = x.test(p.nodeName || "")),
            !S &&
          ...
          return A(t, O), void A(t, O, !0);
        if (
          (u &&
            ("auto" == u ? G(t, !0) : t.setAttribute("sizes", u),
            i.clearAttr && t.removeAttribute(i.sizesAttr)),
          (c = t.getAttribute(i.srcsetAttr)),
          (h = t.getAttribute(i.srcAttr)),
          f)
        )
          for (n = p.getElementsByTagName("source"), s = 0, r = n.length; s < r; s++)
            (o = n[s].getAttribute(i.srcsetAttr)) && n[s].setAttribute("srcset", o);
        c
          ? (t.setAttribute("srcset", c), i.clearAttr && t.removeAttribute(i.srcsetAttr))
          : h &&
    ...
    function G(t, e) {
      ...
      if ((o = t.parentNode)) {
        if (
          ...
          for (; o && o != b.body && !r; ) (r = o.offsetWidth), (o = o.parentNode);
        if (
          !(h = E(t, "lazybeforesizes", { width: r, dataAttr: !!e })).defaultPrevented &&
          (r = h.details.width) &&
          r !== t._lazysizesWidth &&
          (!i.onlyLargerSizes || !t._lazysizesWidth || t._lazysizesWidth < r)
        ) {
          if (
            ((t._lazysizesWidth = r),
            (r += "px"),
            ...
            for (a = o.getElementsByTagName("source"), l = 0, u = a.length; l < u; l++)
  ...
  function (t) {
    function e(e) {
      ...
      return (
        ...
        (this.options.env =
          this.options.env ||
          (0 === Object.keys(t).length && process && !0 !== process.browser
            ? "server"
            : "client")),
        (this.options.mode =
          this.options.mode ||
          ("server" !== this.options.env &&
        ...
        "function" == typeof t.addEventListener &&
          ...
          t.addEventListener("popstate", function (t) {
            if (i.state && null === i.state.previousState) return !1;
            i.trigger("navigate");
          })),
        (this.fragment = {
          get: function () {
            return "pushState" === i.options.mode
              ? t.location.pathname.replace(i.options.root, "")
              : "pushState" !== i.options.mode && t.location
              ? t.location.hash
                ? t.location.hash.split(i.options.hashBang ? "#!" : "#")[1]
                : ""
              : t._pathname || "";
          },
          set: function (e) {
            return (
              "pushState" === i.options.mode
                ? ((e = i.options.root ? i.options.root + e : e),
                  t.history.pushState({}, null, e))
                : t.location
                ? (t.location.hash = (i.options.hashBang ? "!" : "") + e)
                : (t._pathname = e || ""),
              i
            );
          },
          clear: function () {
            return (
              "pushState" === i.options.mode
                ? t.history.pushState({}, null, i.options.root || "/")
                : t.location && (t.location.hash = i.options.hashBang ? "!" : ""),
              i
            );
          },
        }),
    ...
    (e.regexRoute = function (t, e, i, n) {
      return t instanceof RegExp
        ...
        : (t instanceof Array && (t = "(" + t.join("|") + ")"),
          (t = t
            ...
            .replace(/\/\(/g, "(?:/")
            .replace(/\+/g, "__plus__")
            .replace(/(\/)?(\.)?:(\w+)(?:(\(.*?\)))?(\?)?/g, function (t, i, n, s, r, o) {
              return (
                e.push({ name: s, optional: !!o }),
                (i = i || ""),
                (o ? "" : i) +
                  "(?:" +
                  (o ? i : "") +
      ...
      (e.prototype.get = e.prototype.add =
        function (t) {
          var i = this,
            n = [],
            ...
            a = function () {
              ...
              if (a) {
                var l = { params: {}, keys: n, matches: a.slice(1) };
                  ...
                  parent: function () {
                    return (
                      !!!(
                        ...
                        this.previousState.value != this.value
                      ) && this.previousState
                    );
                  },
                  callback: function () {
                    (u.callbackRan = !0), (u.timeStamp = Date.now()), u.next();
                  },
                };
                if (((u.stack = s.concat(r)), i.trigger("match", u, l), !u.runCallback))
                  return i;
                if (
                  ((u.previousState = i.state),
                  (i.state = u),
                  u.parent() && !1 === u.parent().propagateEvent)
                )
                  return (u.propagateEvent = !1), i;
                u.callback();
              }
              return i;
            },
            l =
              "pushState" !== i.options.mode && "server" !== i.options.env
                ? "hashchange"
                : "navigate";
          return a().on(l, a);
        }),
      (e.prototype.trigger = function (t) {
        ...
        return (
          this.events[t] &&
            e._forEach(this.events[t], function (t) {
              t.apply(i, n);
            }),
          this
        );
      }),
      (e.prototype.on = e.prototype.bind =
        function (t, i) {
          var n = this,
            s = t.split(" ");
          return (
            e._forEach(s, function (t) {
      ...
      (e.listen = function () {
        ...
        return (
          arguments[0] && arguments[1]
            ...
            : (i = arguments[0]),
          function () {
            for (var t in i) this.get.call(this, t, i[t]);
            return this;
          }.call(new e(t || {}))
        );
      }),
      "function" != typeof t.define || t.define.amd.grapnel
        ? "object" == typeof module && "object" == typeof module.exports
          ? (module.exports = exports = e)
          : (t.Grapnel = e)
        : t.define(function (i, n, s) {
    ...
    return (
      ...
      (s.prototype = {
        ...
        unregister: function (t, e) {
          ...
          return (
            i && (e ? i.removeHandler(e) : (i.clear(), delete this.queries[t])), this
          );
        },
      }),
      new s()
    ...
    PubSub &&
      ...
      (e.Utility = {
        ...
        forEach: function (t, e, i) {
          ...
          else for (var s = 0, r = t.length; s < r; s++) e.call(i, t[s], s, t);
        },
        extend2: function (t) {
          var e = {},
            i = function (t) {
        ...
        wrap: function (t, e) {
          ...
          for (var i = e.length - 1; i >= 0; i--) {
            var n = i > 0 ? t.cloneNode(!0) : t,
              ...
              r = s.parentNode,
              o = s.nextSibling;
            n.appendChild(s), o ? r.insertBefore(n, o) : r.appendChild(n);
          }
        },
        ...
        getParents: function (e, i) {
          var n = [];
          if (i) var s = i.charAt(0);
          for (; e && e !== t; e = e.parentNode)
            i
              ? (e.tagName.toLowerCase() === i.toLowerCase() && n.push(e),
                "." === s && e.classList.contains(i.substr(1)) && n.push(e),
                "#" === s && e.id === i.substr(1) && n.push(e),
                "[" === s && e.hasAttribute(i.substr(1, i.length - 1)) && n.push(e))
              : n.push(e);
        ...
        extractValues: function (t, e, i) {
          ...
          s && (t = t.toLowerCase()),
            r &&
              (t = t.replace(/\s+/g, function (t) {
                for (var e = "", i = 0; i < r; i++) e += t.charAt(0);
                return e;
              }));
          var u = t.match(l);
          if (!u) return null;
          if (!a) return t === e ? {} : null;
          u = u.splice(1);
        ...
        renderEmail: function (e) {
          ...
          i &&
            Array.prototype.forEach.call(i, function (t, e) {
              ...
              i[e].outerHTML =
                "<a " + s + ' href="mailto:' + n.address + '">' + n.text + "</a>";
            });
        },
        parseTween: function (t) {
          var n,
            ...
            r = e.settings.transitions,
            o = {};
          return (
            "string" == typeof t
              ? (n = r[t] !== i ? r[t] : r.slide)
              : t instanceof Object && !(t instanceof Array) && (n = t),
            e.Utility.forEach(["from", "to", "out"], function (t, i) {
              (o[t] = {}),
                (o[t].vars = e.Utility.extend({}, s, n[t])),
                (o[t].duration =
                  "to" === t ? o[t].vars.duration - 0.01 : o[t].vars.duration),
        ...
        parseYouTube: function (t) {
          var e =
            /\/\/(?:www\.)?youtu(?:\.be|be\.com)\/(?:watch\?v=|embed\/)?([a-z0-9_\-]+)/i.exec(
              t
            );
        ...
        getAbsoluteUrl: function (e) {
          return n || (n = t.createElement("a")), (n.href = e), n.href;
        },
            ...
            s = {
              ...
              ie: function (t) {
                return t
                  ? t >= 11
                    ...
                    : new RegExp("msie " + t).test(e)
                  : /msie/i.test(e) || "ActiveXObject" in window;
              },
              opera: function () {
              ...
              touchDevice: function () {
                return (
                  ...
                  ("DocumentTouch" in window && t instanceof DocumentTouch)
                );
              },
            };
          return s;
        ...
        return (
          ...
          t && t.test
            ? "{{ }}" == s
              ...
              : RegExp(
                  t.source
                    .replace(/\{/g, r[0].replace(/(?=.)/g, "\\"))
                    .replace(/\}/g, r[1].replace(/(?=.)/g, "\\")),
                  t.global ? "g" : ""
                )
            : r[t]
        );
        ...
        return function (e, n) {
          return (
            ...
            (t[e] =
              ...
              (h = []),
              u.map(function (t, e) {
                (e = l.indexOf(t)), h.push(l.slice(0, e), t), (l = l.slice(e + t.length));
              }),
              (a = h.concat(l)),
              new Function(
                "d",
    ...
    (e.Utility.tmpl = a),
      (e.Utility.extend = function () {
        var t,
          ...
          d = !1;
        for (
          "boolean" == typeof u && ((d = u), (u = arguments[1] || {}), (h = 2)),
            "object" != typeof u &&
              ((a = u), "[object Function]" !== l.call(a)) &&
              (u = {}),
            f === h && ((u = this), --h);
          h < f;
          h++
  ...
  (function (t, e, i) {
    ...
    t.addWheelListener = function (t, e, i) {
      a(t, s, e, i), "DOMMouseScroll" == s && a(t, "MozMousePixelScroll", e, i);
    };
  })(window, document),
  function () {
    ("undefined" != typeof exports && null !== exports ? exports : this).Lethargy =
      (function () {
        function t(t, e, i, n) {
  ...
  (function (t, e, i) {
    ...
    (e.VERSION = "0.6.2"),
      ...
      (e.DEFAULTS = {
        ...
        analytics: { _setAccount: "UA-XXXXXXXX-X" },
        ...
        transitions: {
          ...
          none: {
            from: { duration: 0.001, autoAlpha: 0 },
            to: { duration: 0.001, autoAlpha: 1 },
            out: { duration: 0.001, autoAlpha: 0 },
          },
          fade: {
            from: { duration: 0.4, autoAlpha: 0 },
            to: { duration: 0.4, autoAlpha: 1 },
            out: { duration: 0.4, autoAlpha: 1 },
          },
          scale: {
          ...
          slide: { from: { x: "100%" }, to: { x: "0%" }, out: { x: "-100%" } },
          right: { from: { x: "-100%" }, to: { x: "0%" }, out: { x: "100%" } },
          left: { from: { x: "100%" }, to: { x: "0%" }, out: { x: "-100%" } },
          up: { from: { y: "100%" }, to: { y: "0%" }, out: { y: "-100%" } },
          down: { from: { y: "-100%" }, to: { y: "0%" }, out: { y: "100%" } },
          "left-scale": {
            from: { x: "0%", scale: 0.85, autoAlpha: 0 },
            to: { duration: 0.7, x: "0%", scale: 1 },
            out: { x: "-100%", scale: 1, autoAlpha: 1 },
          },
          "right-scale": {
            from: { duration: 0.5, x: "0%", scale: 0.85, autoAlpha: 0 },
            to: { duration: 0.5, x: "0%", scale: 1, delay: 0.2 },
            out: { duration: 0.5, x: "100%", scale: 1, autoAlpha: 1 },
          },
          "down-scale": {
            from: { duration: 0.5, y: "0%", scale: 0.85, autoAlpha: 0 },
            to: { duration: 0.5, y: "0%", scale: 1, delay: 0.2 },
            out: { duration: 0.5, y: "100%", scale: 1, autoAlpha: 1 },
          },
          "up-scale": {
            from: { duration: 0.5, y: "0%", scale: 0.85, autoAlpha: 0 },
            to: { duration: 0.5, y: "0%", scale: 1, delay: 0.2 },
          ...
          "scale-down": {
            from: { duration: 0.5, y: "-100%", scale: 1, autoAlpha: 1 },
            to: { duration: 0.5, y: "0%", scale: 1, delay: 0.2 },
            out: { duration: 0.5, y: "0%", scale: 0.85, autoAlpha: 0 },
          },
          "scale-up": {
            from: { duration: 0.5, y: "100%", scale: 1, autoAlpha: 1 },
            to: { duration: 0.5, y: "0%", scale: 1, delay: 0.2 },
          ...
          "scale-left": {
            from: { duration: 0.5, x: "100%", scale: 1, autoAlpha: 1 },
            to: { duration: 0.5, x: "0%", scale: 1, delay: 0.2 },
            out: { duration: 0.5, x: "0%", scale: 0.85, autoAlpha: 0 },
          },
          "scale-right": {
            from: { duration: 0.5, x: "-100%", scale: 1, autoAlpha: 1 },
            to: { duration: 0.5, x: "0%", scale: 1, delay: 0.2 },
        ...
        project: {
          ...
          hiddenPages: !0,
          buttonSectionIcon:
            '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M4 11h5V5H4v6zm0 7h5v-6H4v6zm6 0h5v-6h-5v6zm6 0h5v-6h-5v6zm-6-7h5V5h-5v6zm6-6v6h5V5h-5z"/></svg>',
          templateCustom:
            '<div class="page page-{{index}} {{skin && "page-skin-"}}{{skin}} {{hide &&"page-hide"}}"> {{content}} {{caption}}</div>',
          template:
            '<div class="page page-{{index}} {{skin && "page-skin-"}}{{skin}} {{hide &&"page-hide"}}"><div class="page-content page-content-{{type}} load" self="{{self}}">{{content}}</div>{{caption}}</div>',
          templateFit:
            '<div class="page page-{{index}} {{skin && "page-skin-"}}{{skin}} {{hide &&"page-hide"}}"><div class="page-content page-content-{{type}} photo-{{fit}} lazyload" background="{{src}}" self="{{self}}" fit="{{fit}}"></div>{{caption}}</div>',
        },
        thumbnails: {
          wrapper:
            '<div class="page thumbs-{{index}}"><div class="page-content"> {{content}} </div></div>',
          id: "THUMBS_PAGE",
          element: ".thumbs",
          parent: ".content",
          buttonViews: !1,
          ...
          buttonSectionIcon:
            '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M4 18h3V5H4v13zM18 5v13h3V5h-3zM8 18h9V5H8v13z"/><path d="M0 0h24v24H0z" fill="none"/> </svg>',
          templateThumb:
            '<div class="thumb thumb-{{index}} photo {{skin && \'thumb-skin-\'}}{{skin}}"><div class="thumb-content"><div class="thumb-photo lazyload" background="{{thumbSrc}}" ></div><div class="thumb-caption">{{thumbCaption}}</div></div></div>',
          templateThumbText:
            '<div class="thumb thumb-{{index}} text {{skin && \'thumb-skin-\'}}{{skin}}"><div class="thumb-content">{{thumbCaption}}</div></div>',
          fit: "contain",
          size: "270x180",
          grid: "4x2",
        },
  ...
  (function (t, e, i, n, s) {
    "use strict";
    (e.config = { sidebar: {}, menu: {}, project: {}, thumbnails: {}, transitions: {} }),
      (e.settings = {}),
      (e.component = {}),
      (e.section = {});
    var r,
    ...
    function u(i) {
      ...
      (e.settings = l.deepExtend({}, e.DEFAULTS, l.deepExtend({}, e.config, i))),
        ...
        (r = e.settings),
        (window.lazySizesConfig = { clearAttr: !0 }),
        this.meta(),
        (o = r.key);
      var s = r.content.keyboard;
      return (
        /all|default/.test(s) && this.keyboard.enable(),
        this.enviroment(),
        ...
        e.subscribe(a.READY, function () {
          ...
          o &&
            (!0 === o || ("auto" === o && l.getEnviroment().touchDevice())) &&
            n.gesture(),
            (e.docs = function (t) {
              var e = t || "";
    ...
    (c.getSettings = function () {
      ...
      (c.meta = function () {
        var i = t.head;
        i.querySelectorAll('meta[name="viewport"]').length ||
          i.insertAdjacentHTML("afterbegin", e.settings.meta);
      }),
      ...
      (c.enquireSetup = function () {
        ...
        for (var o in ((r.replace = function (t) {
          for (
            ...
            this.remove(n[e]);
          for (; r < o; r++) this.add(s[r]);
        }),
        (r.insert = function (t, e) {
          if (r.contains(t)) {
            if (r.item(e) === t) return;
            r.remove(t);
          }
        ...
        s))
          if (s.hasOwnProperty(o)) {
            var a = s[o].split(/(\s*&&\s*)/);
            a.splice(1, 1), i.register(a[0], l(o, a[1]));
          }
        function l(t, i) {
          return {
            match: function () {
              /sm/.test(t)
                ...
                ? r.insert(t, 3)
                : n.classList.add(t),
                e.publish(e.Event.MQ, { key: t, transition: i });
            },
            unmatch: function () {
      ...
      (c.inactivity = {
        enable: function () {
          var i,
            ...
            u = !1,
            h = "on-inactive",
            c = r.content.inactivity,
            p = l.isNumeric(c) ? 1e3 * c : 3e3;
          window.addEventListener(
            "mousemove",
            ((i = function (i) {
              u &&
                (e.publish(a.MOUSE_INACTIVITY, !1), l.removeClass(t.body, h), (u = !1)),
                null !== o && clearTimeout(o),
                (o = setTimeout(function () {
                  u || (e.publish(a.MOUSE_INACTIVITY, !0), l.addClass(t.body, h)),
                    (u = !0);
                }, p));
            }),
            (n = 1e3),
          ...
          (e.keyboard = n),
            e.isSinglePage ||
              ...
              n.bind(o.close, function () {
                e.publish(a.PAGE_CLOSE, "close"), e.publish(a.SECTION_TOGGLE, "section");
              })),
        ...
        userDefined: function () {
          ...
          l.forEach(o, function (t, e) {
            ...
            l.forEach(i, function (t, i) {
              ...
              -1 === s.indexOf(o)
                ? (2 === o.length && (o = o[0] + " " + o[1]),
                  3 === o.length && (o = o[0] + " " + o[1] + " " + o[2]),
                  r.parentNode.hasAttribute("onclick")
                    ? n.bind(o, function () {
                        r.parentNode.click();
                      })
                    : a &&
                ...
                : "#" === a &&
                  /toggle/.test(r.parentNode.getAttribute("onclick")) &&
                  n.bind(o, function () {
  ...
  (function (t, e, i, n) {
    ...
    function l(t, e) {
      return "hash" === e
        ? t.getAttribute(e) || t.getAttribute("data-" + e) || t.getAttribute("id")
        : t.getAttribute(e) || t.getAttribute("data-" + e);
    }
    function u(t) {
      if ("" === t.innerHTML) return "";
      var e = t.getAttribute("class");
      return t.setAttribute("class", "page-caption " + (e || "")), t.outerHTML;
    }
    function h(e) {
      if (!e) return "";
      var i = t.createElement("div");
      return (i.innerHTML = e), u(i);
    }
    function c(t, e) {
      return t.getAttribute("alt") || l(t, "hash") || e.toString();
    }
    function p(t) {
      return t.replace(/(.+)\.(gif|png|jpg)/i, "$1.$2");
    }
    function f(t) {
      ...
      return (
        void 0 === s &&
          (s = new (function () {
            ...
            e.content = [];
            for (
              var g = t.querySelector(e.settings.project.element).children,
                m = g.length,
                _ = 0;
              _ < m;
              _++
              ...
              if (!r.hasClass(v, "caption") && !v.hasAttribute("exclude")) {
                if ((a(v), "IMG" == v.tagName)) {
                  if (
                    ((y.type = "photo"),
                    r.addClass(v, "lazyload"),
                    (y.src = f(v)),
                    r.setAttributes(v, { width: "", height: "", "data-src": y.src }),
                    v.removeAttribute("src"),
                    /staticflickr/i.test(y.src)
                  ...
                  "A" === v.tagName &&
                  /flickr.com\/photos\//i.test(v.getAttribute("href"))
                ) {
                  (y.type = "photo flickr"),
                    (y.service = "flickr"),
                  ...
                  w &&
                    ((x = b.querySelector(".thumb-caption")),
                    (y.thumbCaption = x ? x.innerHTML : b.innerText)),
                    (y.self = l(v, "self") || null),
                    y.self && v.removeAttribute("self"),
                    (y.content = v.outerHTML);
                  ...
                  "A" === v.tagName &&
                  v.firstElementChild &&
                  "IMG" === v.firstElementChild.nodeName
                )
                  (y.type = "photo link"),
                    (y.service = "local"),
                    (T = v.querySelector("img")),
                    (y.src = f(T)),
                    r.setAttributes(T, { "data-src": y.src, src: "" }),
                    r.addClass(T, i && i.cfg.lazyClass),
                    (y.thumbSrc = p(y.src)),
                    (y.caption = r.hasClass(b, "caption")
                      ? u(b)
                      : h(T.getAttribute("alt"))),
                    (y.thumbCaption = c(v, n)),
                    w &&
                      ((x = b.querySelector(".thumb-caption")),
                      (y.thumbCaption = x ? x.innerHTML : b.innerText)),
                  ...
                  if (((y.src = v.getAttribute("src")), /vimeo|youtu/.test(y.src))) {
                    y.type = "video";
                    var C = /YOUTU/i.test(y.src)
                      ? "youtube"
                      : /VIMEO/i.test(y.src)
                      ? "vimeo"
                      : null;
                    (y.caption = "P" === b.tagName ? b.outerHTML : ""),
                      ...
                      "youtube" === C
                        ? ((y.type = "video youtube"),
                          (y.thumbSrc = r.parseYouTube(y.src)))
                        : ((y.type = "video vimeo"),
                          (y.thumbSrc = "loadi.gif"),
                  ...
                  if (
                    "FIGURE" === v.tagName ||
                    "ARTICLE" === v.tagName ||
                    v.getAttribute("layout")
                  ) {
                    var O = v.querySelectorAll(
                      ...
                      r.forEach(O, function (t, e) {
                        t.removeAttribute("data-flickr-embed"),
                          t.nextElementSibling &&
                            "SCRIPT" === t.nextElementSibling.tagName &&
                    ...
                    for (y.thumbSrc = []; A < E.length; A++) {
                      ...
                      /staticflickr/i.test(M)
                        ? y.thumbSrc.push(M.replace(/(\_[A-Z].jpg|\.jpg)/i, "_n.jpg"))
                        : y.thumbSrc.push(p(M));
                    }
                  }
                  if (
                    (r.hasClass(v, s)
                      ? (y.content = v.innerHTML)
                      : (r.addClass(v, s),
                ...
                if (0 !== Object.keys(y).length && "SCRIPT" !== v.tagName) {
                  ...
                  if (
                    (X && (y.skin = X),
                    y.thumbCaption &&
                      !/<[\s\S][*|a-z][\s\S]/gm.test(y.thumbCaption) &&
                      (y.thumbCaption =
                        y.thumbCaption.length > 48
                          ? y.thumbCaption.substr(0, 48) + "..."
                          : y.thumbCaption),
                    ...
                    "A" === v.tagName &&
                      v.hasAttribute(o) &&
                      y.thumbSrc.push(p(v.getAttribute(o)));
  ...
  (function (t, e, i, n) {
    ...
    var s,
      r = function (n) {
        ...
        "icon" === s &&
          (r.buttonNext || (u.buttonNext = "icon"),
          r.buttonPrevious || (u.buttonPrevious = "icon"),
          r.buttonSection || (u.buttonSection = "icon")),
          o.extend(r, u);
        var h = r.grid.split("x");
        (r.cols = h.length > 1 ? +h[0] : 4), (r.rows = h.length > 1 ? +h[1] : 3);
        var c = 0,
          p = !1;
        if (!p) for (var f = 0; f < l.length; f++) l[f].hide || c++;
        (r.itemsLength = p ? l.length : c),
          (r.itemsPerPage = r.rows * r.cols || r.itemsLength),
          (r.totalPages =
            ~~(r.itemsLength / r.itemsPerPage) +
            (r.itemsLength % r.itemsPerPage > 0 ? 1 : 0)),
        ...
        if (!d) {
          ...
          o.forEach(l, function (t, e) {
            var i,
              n = t;
            (!p && n.hide) ||
              (Array.isArray(n.thumbSrc) && 0 == n.thumbSrc.length
                ? (v += a(r.templateThumbText, n))
                : (v += a(r.templateThumb, n)),
              (y % m != m - 1 && y !== r.itemsLength - 1) ||
                ((i = v), (g += a(r.wrapper, { index: _, content: i })), _++, (v = " ")),
              y++);
          }),
        ...
        function w(t) {
          ...
          var n,
            s,
            a = t.target;
          o.getParents(a, r.trigger) &&
            (n = o.getParents(a, ".thumb")[0]) &&
            ((s = p ? b.getItemIndex(n) : /\d+/gi.exec(n.getAttribute("class"))[0] - 1),
  ...
  (function (t, e, i, n) {
    ...
    var s,
      ...
      l,
      u = e.Utility,
      h = { normal: "1:1", contain: "fit", cover: "cover" },
      c = function (a) {
        var l = u.tmpl,
        ...
        var d = {
          ...
          onPageTransitionEnd: function () {
            e.publish(e.Event.PAGE_TRANSITION_END, {
              ...
              r !== n &&
                (/photo/g.test(t.type) && !/contain|cover/g.test(t.fit)
              ...
              n = function (t) {
                ...
                h &&
                  (u.forEach(h, function (t, e) {
                    s.timeline.isActive() || i.isTweening(g)
                      ? _.push(t)
                      : (u.removeClass(t, "load"), t.removeEventListener("load", n));
                  }),
                  e && (y(), (e = !1)));
              };
        ...
        "icon" === c &&
          (p.buttonNext || (d.buttonNext = "icon"),
        ...
        return (
          u.forEach(e.content, function (t, e) {
            if (((t.index = e + 1), "custom" === t.type))
              t.caption
                ? (m += l(p.templateCustom, t))
                : ((t.caption = ""), (m += l(v, t)));
            else {
    ...
    (p.loadImages = function (t) {}),
      (p.view = function (e, i) {
        var n = this.currentView,
          s = "on-photo-fit-",
          r = t.body;
        u.removeClass(r, s + n), u.addClass(r, s + e), (this.currentView = e);
      }),
      ...
      (p.next = function () {
        ...
        this.view(t), this.setPageBasedOnView(), (o.innerText = h[a]);
      }),
      (p.prev = function () {}),
      ...
      (p.getNextView = function () {
        var t = this,
          ...
          s = e[n + 1 > i - 1 ? 0 : n + 1];
        return (a = e[t.VIEWS.indexOf(s) + 1 > i - 1 ? 0 : t.VIEWS.indexOf(s) + 1]), s;
      }),
      (p.setPageBasedOnView = function (t) {
        var i,
          n = [],
          s = (t = t || this.project).options,
          r = t.getPage("next"),
          o = t.getPage("prev"),
          a = t.getPage("current"),
          l = ((i = s.prevPage), Math.max(0, Math.min(i, s.totalPages - 1))),
          h = "photo-enlarged",
          c = /contain|cover/.test(this.currentView);
        if ((o && n.push(o), a && n.push(a), r && n.push(r), c))
  ...
  (function (t, e, i, n, s, r) {
    ...
    var o,
      ...
      w = {
        ...
        buttonSection:
          '<div class="ui ui-button ui-button-section" title="Toggle section (Esc)"><span>{{label}}</span></div>',
        buttonViews:
          '<div class="ui ui-button ui-button-views" title="Toggle photo view (v)"><span>{{label}}</span></div>',
        buttonViewsIcon:
          '<svg width="24" height="24" viewBox="0 0 24 24">                                        <path d="M12.01 5.5L10 8h4l-1.99-2.5zM18 10v4l2.5-1.99L18 10zM6 10l-2.5 2.01L6 14v-4zm8 6h-4l2.01 2.5L14 16zm7-13H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16.01H3V4.99h18v14.02z"/>                                         </svg>',
        buttonPrevious:
          '<div class="ui ui-button ui-button-prev" title="Previous page (&leftarrow;)"><span>{{label}}</span></div>',
        buttonPreviousIcon:
          '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/></svg>',
        buttonNext:
          '<div class="ui ui-button ui-button-next" title="Next page (&rightarrow;)"><span>{{label}}</span></div>',
        buttonNextIcon:
          '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>',
        buttonClose:
          '<div class="ui-button ui-button-close" title="Close page (Esc)"><span>{{label}}</span></div>',
        buttonCloseIcon:
          '<svg height="24" viewBox="0 0 24 24" width="24">                                        <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/>                                         <path d="M0 0h24v24H0z" fill="none"/>                                    </svg>',
        pagination:
          '<ul class="ui ui-pagination horizontal">@@<li class="{{hide}}"><a><span class="dot"></span></a></li>@@</ul>',
      ...
      x = function (i, n) {
        return (
          ...
          this.options.isSinglePage ||
            (this._setPages(this.options.currentPage), this._playTransition(!0)),
    ...
    (x.prototype = {
      _build: function () {
        ...
        if ("THUMBS_PAGE" === o.id)
          if (/x/.test(o.size)) {
            var l = v.extractValues(o.size, "{w}x{h}", { whitespace: 1 });
            l.w, l.h;
            (a +=
              ".thumb-photo {background-size: " +
              o.fit +
              ";padding-top: 0 !important; max-width: " +
              l.w +
              "px ; max-height: " +
              l.h +
              "px ; margin: 0px auto;}"),
            ...
            /cover|contain/.test(o.size) &&
              (a += ".thumb-photo {background-size: " + o.fit + ";}");
        if ("THUMBS_PAGE" === o.id && "string" == typeof o.grid && (o.cols || o.rows)) {
          o.gutterH, o.gutterV, o.padding;
          (i = v.isNumeric(o.cols) ? 100 / o.cols + "%" : "inherit"),
            v.isNumeric(o.rows)
              ? (n = 100 / o.rows + "%")
              : ((a += ".thumb { margin-bottom:48px;} "), (n = "initial")),
            (o.itemsPerPage = o.rows * o.cols || o.itemsLength),
            (a += ".thumb {width: " + i + "; height: " + n + "; }.-md .thumb { } "),
            1 !== o.cols &&
              (a += ".-md.portrait .thumb {width:" + n + "; height:" + i + "; } ");
        }
        if ("THUMBS_PAGE" === o.id && 1 === o.totalPages) {
          (o.isSinglePage = !0), v.addClass(f, "thumbs-single-page");
        ...
        if (0 !== a.length) {
          ...
          c
            ? c.insertAdjacentHTML("afterEnd", p)
            : t.head.insertAdjacentHTML("beforeend", p);
        }
        (this.options.pages = this.element.querySelectorAll(".page")),
          (o.totalPages = o.pages.length),
          "THUMBS_PAGE" === o.id
            ? ((o.currentPage = 1), (s = "thumbnails"))
            : (s = "project");
        var d = "{{label}}",
          g = /<[a-z\][\s\S]*>/i,
          m = /^(<svg)/m;
        function _(t) {
          if ("string" == typeof o[t] || "icon" === e.settings.content.ui) {
            if ("icon" === o[t]) {
              var i,
                n = t + "Icon";
              return (i = o[n] || w[n]), e.Utility.tmpl(w[t], { label: i });
            }
            return o[t];
          }
          return !0 === o[t] && w[t];
        ...
        var b = _("pagination");
        b && o.totalPages > 1 && !v.hasClass(r.element, "no-pagination")
          ? (/(^vertical$)|(^horizontal$)/g.test(b) &&
              (b = w.pagination.replace("horizontal", b)),
            (this.bullets = this._paginationInit(r.element, b)))
          : (v.addClass(r.element, "no-pagination"), (o.pagination = !1));
        var x = _("buttonPrevious"),
          T = _("buttonNext");
        (x || T) && o.totalPages > 1
          ? (x && (x = y(x, "buttonPrevious", "prev")),
        ...
        var P = _("buttonViews");
        P &&
          ((P = y(P, "buttonViews", "fit")),
          (r.viewsButton = r._viewsButtonInit(r.element, P)));
        var S = _("buttonSection");
        S &&
          e.settings.thumbnails &&
          o.totalPages > 1 &&
          ((S = y(S, "buttonSection", "project" === s ? "thumbnails" : "project")),
          (r.sectionButton = r._sectionButtonInit(r.element, S))),
          "project" === s &&
            e.settings.project.hiddenPages &&
            (h = _("buttonClose")) &&
            (h = y(h, "buttonClose", "close"));
        var C = _("enumeration");
        return (
          C && o.totalPages > 1
            ? ((r.enumeration = r._enumerationInit(r.element, C)), r._updateEnumeration())
            : (o.enumeration = !1),
          this
        );
      },
      ...
      next: function () {
        (this.options.direction = "forward"), this.goTo(this.options.currentPage + 1);
      },
      prev: function () {
        (this.options.direction = "backward"), this.goTo(this.options.currentPage - 1);
      },
      goTo: function (t, e, i) {
        var n = this.options;
        n.status.playing ||
          n.isSinglePage ||
          t === n.currentPage ||
          (t > n.totalPages - 1 || t < 0
            ? e !== r || n.status.playing || this._playEdgeTransition()
            : ((n.animate = !(e !== r && !1 === e)),
              this.options.active &&
                (this._setPages(t),
                n.status.initialized && !b
      ...
      _setPages: function (t) {
        var i,
          n = this.options,
          s = n.id === e.settings.project.id;
        arguments.length
          ? ((n.direction = t < n.currentPage ? "backward" : "forward"),
            "forward" === n.direction
              ? (n.nextPage = t >= n.totalPages ? n.totalPages : t)
              : (n.prevPage = t <= -1 ? 0 : t),
            s &&
              n.hiddenPages &&
              (o[n.currentPage].hide && (i = n.currentPage),
              o[t] && o[t].hide && (i = t)))
          : ((n.currentPage = "forward" === n.direction ? n.nextPage : n.prevPage),
            (n.prevPage = n.currentPage <= -1 ? 0 : n.currentPage - 1),
            (n.nextPage =
              n.currentPage >= n.totalPages ? n.totalPages - 1 : n.currentPage + 1)),
          s
            ? (i === r &&
                (i =
                  "forward" === n.direction
                    ? n.nextPage < n.totalPages
                      ? n.nextPage
                      : n.totalPages - 1
                    : n.currentPage),
              (a = o[i].transition),
              (n.tween = this._transitions(a)))
            : (a = e.settings.thumbnails.transition),
          this._setTweens();
      },
      _setTweens: function () {
        var t = this,
        ...
        v.forEach(m, function (t, n) {
          ...
          "forward" === e.direction && o
            ? (u
                ? ((o.style.zIndex = y), y++, (r.style.zIndex = y))
                : ((o.style.zIndex = y), (r.style.zIndex = y++)),
              n.set(o, e.tween.from.vars),
              t.timeline
                .to(o, i.to, e.tween.to.vars, "go")
                .to(r, i.out, e.tween.out.vars, "go"))
            : l &&
              (u
                ? ((r.style.zIndex = y), y++, (l.style.zIndex = y))
                : ((l.style.zIndex = y), (r.style.zIndex = y++)),
              n.set(l, e.tween.out.vars),
              t.timeline
                .to(l, i.to, e.tween.to.vars, "go")
                .to(r, i.from, e.tween.from.vars, "go"));
      },
      _preloadImages: function () {
        var t,
          e,
          i = this.options,
          n = "." + lazySizes.cfg.lazyClass;
        function s(t) {
          t.length &&
            v.forEach(t, function (t, e) {
              lazySizes.unveilLazy(t);
            });
        }
        "forward" === i.direction
          ? ((e = i.pages[i.nextPage]), (t = i.pages[i.nextPage + 1]))
          : ((e = i.pages[i.prevPage]), (t = i.pages[i.prevPage - 1])),
      ...
      _beforeTransitionStart: function () {
        ...
        if (i.active) {
          ...
          if (
            (g && n.set(g, m),
            r
              ? (b && n.set(b, m), y && w && n.set(w, m))
              : (w && n.set(w, m), y && b && n.set(b, m)),
            ...
            l !== "on-transition-" + a &&
              (v.removeClass(f, l), (l = "on-transition-" + a), v.addClass(f, l)),
            p)
          ) {
            if ((s = o[t - 1].skin)) {
              var x = "on-skin-" + s;
              ...
              i.currentSkinClass &&
                (v.removeClass(d, i.currentSkinClass), (i.currentSkinClass = !1));
            this.options.hiddenPages &&
              ((c = o[t - 1].hide)
                ? (v.addClass(f, _),
                  u
                    ? i.pages[t - 1].insertBefore(u, i.pages[t - 1].firstChild)
                    : (u = this._closeButtonInit(i.pages[t - 1], h)))
                : v.hasClass(f, _) && v.removeClass(f, _));
          }
      ...
      _hideUnusedPages: function () {
        var t = this.options,
          ...
          i = this.getPage("next"),
          s = (t.pages[t.currentPage + 1], this.getPage("prev"));
        t.pages[t.currentPage - 1];
        t.status.initialized &&
          t.canHidePages &&
          ("forward" === t.direction
            ? (s && n.set(s, { autoAlpha: 0, clearProps: "all" }),
              e && n.set(e, { autoAlpha: 0, clearProps: "all" }))
            : (i && n.set(i, { autoAlpha: 0, clearProps: "all" }),
              e && n.set(e, { autoAlpha: 0, clearProps: "all" })));
      },
      getPage: function (t) {
        var e,
      ...
      _sectionButtonInit: function (t, i) {
        ...
        return (
          ...
          t.insertBefore(n, t.firstChild),
          n.addEventListener("click", function (t) {
            t.preventDefault(), t.stopPropagation(), e.publish(e.Event.SECTION_TOGGLE);
          }),
          this.uis.push(n),
          n
        );
      ...
      _closeButtonInit: function (t, e) {
        ...
        return (
          ...
          i.addEventListener("click", function (t) {
            t.preventDefault(), t.stopPropagation(), n._closeButtonHandler();
          }),
          i
        );
      },
      ...
      _viewsButtonInit: function (t, i) {
        ...
        return (
          ...
          t.insertBefore(n, t.firstChild),
          n.addEventListener("click", function (t) {
            t.preventDefault(), t.stopPropagation(), e.publish(e.Event.PAGE_VIEW);
          }),
          this.uis.push(n),
          n
        );
      ...
      _hideUIs: function () {
        n.to(this.uis, 1, { autoAlpha: 0, scale: 0.6 }),
          (this.options.status.uiVisible = !1);
      },
      _showUIs: function () {
        n.to(this.uis, 0.2, { autoAlpha: 1, scale: 1, clearProps: "all" }),
          (this.options.status.uiVisible = !0);
      },
      _inactivityHandler: function (t, e) {
        e
          ? this.options.status.uiVisible && this._hideUIs()
          : !this.options.status.uiVisible && this._showUIs();
      },
        ...
        if (a.active) {
          if (g) {
            if (!(t < 0 || t > a.totalPages - 1))
              return e.publish(e.Event.MENU, "menu"), void (g = !1);
            a.status.playing && this._playEdgeTransition();
          }
          var l;
          if (t < 0 || t > a.totalPages - 1) this.goTo(t);
          else
            "THUMBS_PAGE" === a.id
              ? ((s = "/" + a.route + "/"),
                (l = t),
                (n = Math.max(0, Math.min(l, a.totalPages - 1)) + 1))
              : ((s = "/"), (n = o[t].hash)),
              (i !== r && s + n === e.router.currentHash) ||
                ("PROJECT_PAGE" !== a.id || o[a.currentPage].hide || (p = a.currentPage),
                e.router.fragment.set(s + n),
                (e.router.currentHash = s + n),
                b ? ((b = !1), this._setPages(t)) : this.goTo(t, !0, !0));
        }
      },
      ...
      _requestPageHandler: function (t, e) {
        if (this.options.active) {
          var i = this.options;
          if ((t && "drag" === t && (b = !0), !1 === i.status.playing)) {
            if (c) return this._closeButtonHandler(), void (c = !1);
            switch (e) {
              case "next":
                (i.direction = "forward"), this._requestPageChange(n(i.nextPage, 1));
                break;
              case "prev":
                (i.direction = "backward"), this._requestPageChange(n(i.prevPage, -1));
                break;
              case "first":
                (i.direction = "backward"), this._requestPageChange(n(0, 1));
                break;
              case "last":
                (i.direction = "forward"),
        ...
        function n(t, e) {
          if ("PROJECT_PAGE" === i.id) {
            if (o[t] && !o[t].hide) return t;
            var n = t;
            if (e > 0) {
              for (; n < i.totalPages; n++) if (!o[n].hide) return n;
            } else for (; n > 0; n--) if (!o[n].hide) return n;
      ...
      _updateButtons: function (t) {
        this.options.active
          ? (n.to(this.buttonPrevious, 0.3, { opacity: 1 }),
            n.to(this.buttonNext, 0.3, { opacity: 1 }))
          : (n.set(this.buttonPrevious, { opacity: 0 }),
            n.set(this.buttonNext, { opacity: 0 }));
      },
      _paginationInit: function (t, i) {
        var n,
          ...
          l = "",
          u = "PROJECT_PAGE" === a.id,
          h = e.Utility.extractValues(i, "{wrapper}@@{bullet}@@{wrapperClose}", {
            whitespace: 1,
          });
        ...
        return (
          n.addEventListener("click", function (t) {
            var e;
            if (
              (t.preventDefault(), t.stopPropagation(), (e = v.getParents(t.target, f)))
            ) {
      ...
      getItemIndex: function (e) {
        return Array.prototype.indexOf.call(
          t.querySelectorAll(this.options.itemClass),
          e
        );
      },
      getPageByIndex: function (e) {
        ...
        return ~~(
          Array.prototype.indexOf.call(
            t.querySelectorAll(this.options.itemClass),
            t.querySelector(this.options.itemClass + "-" + e)
          ) / i.itemsPerPage
        );
      },
      refresh: function () {},
  ...
  (function (t, e, i) {
    ...
    var n,
      ...
      l = "submenu-trigger",
      u = "submenu-open",
      h = t.querySelector("html"),
      c = 1,
      p = !1;
    function f(t, i) {
      var n = this;
      return (
        (r = e.settings.sidebar.align),
        (n.triggers = ""),
        (n.element = t),
        (n.index = i + 1),
    ...
    (d.init = function () {
      ...
      (d.build = function () {
        var t,
          e,
          i = this.element.previousElementSibling,
          n = this.element.parentNode,
          s = n.removeChild(this.element),
          r = '<ul class="menu-content">',
          o = !1,
          l = s.children;
        a.forEach(l, function (i, n) {
          (e = i.nextElementSibling),
            ...
            (r +=
              '<li class="menu-item' + (!o && t ? " submenu submenu-" + c++ : "") + '">'),
            t
              ? o
                ? (r += i.outerHTML + "</li>")
                : (a.addClass(i, "submenu-trigger"),
                  (r += i.outerHTML + '<ul class="submenu-content">'),
                  (o = !0))
              : o
              ? ((r += i.outerHTML + "</li></ul></li>"), (o = !1))
              : (r += i.outerHTML + "</li>");
        }),
          (r += "</ul>"),
          (s.innerHTML = r),
      ...
      (d.closeSubmenu = function (e) {
        ...
        (i.nextElementSibling.style.maxHeight = 0), a.removeClass(i.parentNode, u);
      }),
        ...
        (e.triggers = n),
          a.forEach(n, function (t, n) {
            var s = t.parentNode,
              ...
              o = r.clientHeight + 10;
            i.push(o), r && (r.style.maxHeight = 0);
    ...
    (_.build = function () {
      ...
      this.parent.addEventListener(s, function (e) {
        ...
        e.settings.menu.mouseleave &&
          t.parent.addEventListener("mouseleave", function (e) {
      ...
      (_.openActive = function () {
        !p &&
          o &&
          this.submenu.querySelector("a.active") &&
          (this.open(), (this.hasActiveItem = !0), (p = !0));
      }),
      (_.open = function () {
        var t,
          e = this;
  ...
  (function (t, e, i, n, s, r) {
    ...
    function A() {
      ...
      for (var w, A = i.Event, O = arguments.length, E = 0; E < O; E++) {
        ...
        "string" == typeof k
          ? (_ = k)
          : null != (w = k) && "[object Object]" === Object.prototype.toString.call(w)
          ? (S = k)
      ...
      R.thumbnails
        ? x.addClass(e.body, "on-thumbs-enabled")
        : x.addClass(e.body, "on-thumbs-disabled"),
        i.Parser(),
      ...
      (g = I || _ || "/" + p[0].hash),
        ...
        i.router.get("*", function (t, e) {
          e.parent() || (e.preventDefault(), e.stopPropagation(), N());
        });
      var z = e.querySelector(R.sidebar.element);
      function F() {
        a &&
          ((C = a.getOptions("totalPages")),
          ...
          (h = new n({
            ...
            .set(a.element, l.from.vars, "thumbs")
            .to(a.element, l.to.duration, l.to.vars, "thumbs")
            .to(u.element, l.out.duration, l.out.vars, "thumbs"),
          (c = new n({
            paused: !0,
            onComplete: function () {
            ...
            .set(u.element, l.out.vars, "project")
            .to(u.element, l.to.duration, l.to.vars, "project")
            .to(a.element, l.from.duration, l.from.vars, "project")),
          "thumbs" === d && X(f),
          d !== m && Y(!0),
          j(m);
      }
      function B(t, e) {
        P
          ? ((f = +f - 1),
            ...
            (b = u.getOptions()),
            (a = !1 !== R.thumbnails && !i.isSinglePage && i.section.thumbs(f)) &&
              (y = a.getOptions()),
            F(),
            (P = !1))
          : "project" === t
          ? (function (t) {
              if (!1 === P) {
                var e = +t;
                "thumbs" === m
                  ? u.options.currentPage !== e - 1
                    ? ((i = e - 1), (b.active = !0), u.goTo(i, !1), (b.active = !1), Y())
                    : Y()
                  : u._requestPageChange(e - 1, !0);
              }
              var i;
            })(e)
          : (function (t) {
              if (!1 === P) {
                var e = +t;
                "project" === m ? (X(e - 1), Y()) : a._requestPageChange(e - 1, !0);
              }
            })(e);
      }
      function X(t) {
        (y.active = !0), a.goTo(t, !1), (y.active = !1);
      }
      function Y(t) {
        if (!c.isActive() && !h.isActive())
          if ("project" === m) {
            if (b.status.playing) return;
            t && h ? h.progress(1, !1) : h.restart(!0, !1), (m = "thumbs");
          } else {
            if (y.status.playing) return;
            t ? c.progress(1, !1) : c.restart(!0, !1), (m = "project");
          }
      }
      function j(t) {
        var i = "project" === t ? "on-thumbs" : "on-project";
        x.removeClass(e.body, i), x.addClass(e.body, "on-" + t);
      }
      if (
        (z ? (i.sidebar = new i.section.sidebar(z, R.sidebar)) : (R.sidebar = !1),
        L.enquireSetup(),
        a &&
          (i.subscribe(A.SECTION_TOGGLE, function () {
            !1 !== u.isCurrentPageHidden() &&
              (function () {
                if (
                  !b.status.playing &&
                  !((a && y.status.playing) || c.isActive() || h.isActive())
                )
                  if ("project" === m) {
                    var t = a.getPageByIndex(b.currentPage + 1);
                    i.router.fragment.set("/" + y.route + "/" + (+t + 1));
                  } else i.router.fragment.set("/" + p[b.currentPage].hash);
              })();
          }),
        ...
        var H = t[R.onReady];
        "function" == typeof H && H();
      } else "function" == typeof R.onReady && R.onReady.call(this);
      return (
        v && v.call(this),
        s.to([".project", ".sidebar", ".thumbs"], 0.3, {
          opacity: 1,
          onComplete: function () {
    ...
    i.init = function (t, e, i) {
      return void 0 === w && (w = new A(t, e, i)), w;
    };
  })(
    window,
    document,
  ...
  (function (t, e, i, n, s) {
    ...
    function g(i, n) {
      return (
        "icon" === e.settings.content.ui &&
          (n.buttonToggle || (n.buttonToggle = "icon"),
        ...
        (this._isMenu = !1),
        (this._transitions = { open: {}, close: {} }),
        (this.status = { opened: !1, initialized: !1 }),
        this.init(),
    ...
    (g.ID = "sidebar"),
      (g.DEFAULT_OPTIONS = {
        id: g.ID,
        buttonToggle:
          '<div class="ui ui-button ui-button-toggle" title="Toggle menu (m)"><span>{{label}}</span></div>',
        buttonClose:
          '<div class="ui-button ui-button-close" title="Close menu (m)"><span>{{label}}</span></div>',
        parent: "body",
        mq: "none",
        buttonToggleIcon:
          '<svg width="24" height="24" viewBox="0 0 24 24"><path class="menu" d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"/></svg>',
        buttonCloseIcon:
          '<svg fill="#000000" height="24" viewBox="0 0 24 24" width="24">                                        <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/>                                         <path d="M0 0h24v24H0z" fill="none"/>                                    </svg>',
        iconOpen: "icon-menu",
    ...
    (m.init = function () {
      ...
      (e.panelClass = {
        ...
        this.alignList.indexOf(e.align) > -1 &&
          (e.alignClass = "on-" + e.classPrefix + "-" + e.align),
        e.id === g.ID && (this._isMenu = !0),
        !p.hasClass(i, e.alignClass) &&
          this._isMenu &&
          (p.addClass(i, e.alignClass),
          p.addClass(this.panel, e.classPrefix + "-" + e.align));
      var n = (this.status.opened =
          !p.hasClass(t.head, e.classPrefix + "-mobile") && !e.hidden),
        s = /<[a-z\][\s\S]*>/i;
      function r(t, i) {
        var n,
          r = { label: i };
        return (
          "string" == typeof e[t]
            ? (n = s.test(e[t])
                ? p.tmpl(e[t], r)
                : "icon" === e[t]
                ? p.tmpl(g.DEFAULT_OPTIONS[t], { label: g.DEFAULT_OPTIONS[t + "Icon"] })
                : p.tmpl(g.DEFAULT_OPTIONS[t], { label: e[t] }))
      ...
      (m.onFolioReady = function () {
        this.setDefaultTweens(), this.setTransitions();
      }),
      (m.setDefaultTweens = function () {
        ...
        switch (this.options.align) {
          case "left":
            (i.pull = {
              opened: { left: t, zIndex: 201, opacity: 1, scale: 1, ease: Expo.easeOut },
              closed: {
                left: 0,
                zIndex: 201,
                opacity: 1,
              ...
              (n.pull = {
                opened: { x: 0, opacity: 1, scale: 1, ease: Quart.easeOut, delay: 0.04 },
                closed: { x: -50, opacity: 0, scale: 0.97, ease: Cubic.easeOut },
              }),
              (i.cover = {
                opened: { x: "0%", opacity: 0.4, scale: r(), ease: Expo.easeOut },
                closed: { x: "0%", opacity: 1, scale: 1, ease: Expo.easeInOut },
              }),
              (n.cover = {
                opened: {
                  x: "0%",
                ...
                closed: { x: "-100%", opacity: 1, scale: 1, ease: Expo.easeInOut },
              }),
              (i.push = {
                opened: { x: t, opacity: 0.4, scale: 1, ease: Expo.easeOut },
                closed: { x: "0%", opacity: 1, scale: 1, ease: Expo.easeInOut },
              }),
              (n.push = {
                opened: { x: "0%", opacity: 1, scale: 1, ease: Expo.easeOut },
                closed: { x: "-" + t, opacity: 1, scale: 1, ease: Expo.easeInOut },
              });
            break;
          case "right":
            (i.pull = {
              opened: { right: t, opacity: 1, scale: 1 },
              closed: { right: 0 },
            }),
              (n.pull = { opened: { x: 0, opacity: 1 }, closed: { x: t, opacity: 1 } }),
              (i[s] = {
                opened: { right: 0, opacity: 0.4, scale: r(0.8) },
                closed: { right: 0, opacity: 1, scale: 1 },
              }),
              (n[s] = { opened: { x: 0, opacity: 1 }, closed: { x: t, opacity: 1 } }),
              (i.push = {
                opened: { x: "-" + t, opacity: 0.4, scale: 1, ease: Expo.easeOut },
                closed: { x: "0%", opacity: 1, scale: 1, ease: Expo.easeInOut },
              }),
          ...
          case "top":
            (i.pull = {
              opened: { top: e, opacity: 1, scale: 1 },
              closed: { top: 0, opacity: 1, scale: 1 },
            }),
              (n.pull = {
                opened: { y: 0, opacity: 1 },
                closed: { y: "-" + e, opacity: 1 },
              }),
              (i[s] = {
                opened: { top: 0, opacity: 0.8, scale: r(0.8) },
                closed: { top: 0, opacity: 1, scale: 1 },
              }),
              (n[s] = {
                opened: { y: "0%", opacity: 1 },
                closed: { y: "-100%", opacity: 1 },
              }),
              (i.push = {
                opened: { y: e, opacity: 0.4, scale: 1 },
          ...
          case "bottom":
            (i.pull = {
              opened: { bottom: e, scale: 1 },
              closed: { bottom: "0%", opacity: 1, scale: 1 },
            }),
              (n.pull = {
                opened: { y: "0%", opacity: 1 },
                closed: { y: e, opacity: 1 },
              ...
              (i[s] = {
                opened: { bottom: 0, opacity: 0.8, scale: r(0.8) },
                closed: { bottom: 0, opacity: 1, scale: 1 },
              }),
              (n[s] = { opened: { y: 0, opacity: 1 }, closed: { y: e, opacity: 1 } }),
              (i.push = {
                opened: { y: "-" + e, opacity: 0.4, scale: 1 },
                closed: { y: 0, opacity: 1, scale: 1 },
              }),
              (n.push = { opened: { y: 0, opacity: 1 }, closed: { y: e, opacity: 1 } });
        }
      }),
      (m.toggle = function (t) {
        var e = this.getOptions();
        (!e.toggle && "-sidebar" !== e.mq && this.status.opened) ||
          ((e.duration = arguments.length && parseFloat(t) ? t : 0.3),
      ...
      (m.setTransitions = function () {
        ...
        u && u.invalidate().kill(),
          h && h.invalidate().kill(),
          i.set(m, { clearProps: "all" }),
          i.set(m, t.panelTween[f][v]),
          i.set(_, { clearProps: "all" }),
      ...
      (m.updateTransitions = function () {
        ...
        "opened" === this.getPanelState()
          ? (r.updateTo(this.panelTween[t].opened).invalidate(),
            a.updateTo(this.contentTween[t].opened).invalidate())
          : (o.updateTo(this.panelTween[t].closed).invalidate(),
      ...
      (m.addCloseListener = function () {
        /push|cover/.test(this.options.transitionType) &&
          ((c = !0), this.content.addEventListener("mouseup", this.close.bind(this)));
      }),
      (m.removeCloseListener = function () {
        !0 === c &&
          ((c = !1), this.content.removeEventListener("mouseup", this.close.bind(this)));
      }),
      (m.open = function () {
        ...
        if (this._isMenu && i.transition) {
          ...
          "-sidebar" === i.key
            ? ((f = !1),
              ...
              p.addClass(t.body, n.panelClass.closed))
            : "sidebar-" === i.key && (f = !0),
            (n.mq = i.key),
  ...
  (function (t, e, i) {
    ...
    function h(e) {
      ...
      o.addClass(e, "active"), i && i != e && o.removeClass(i, "active"), s, r && l();
    }
          ...
          (function () {
            ...
            o.forEach(c, function (t, e) {
              if (n === i) {
                ...
                "#" !== u &&
                  ((u = (u = u.replace(/^(\.)+\//gm, l || a + "/")).replace(
                    /#(\S*)/g,
                    ""
                  )),
                  new RegExp(u),
                  (o = u),
                  -1 !== (r = p).indexOf(o, r.length - o.length) &&
                    ((s = t.getAttribute("href").replace(/#(\S*)/g, "")), (n = t)));
              }
            }),
              n === i &&
                "/" === p.slice(-1) &&
                ((p = a + "/index." + e.settings.menu.fileExtension),
                o.forEach(c, function (t, e) {
  ...
  (function (t, e, i) {
    ...
    (e.next = function () {
      ...
      (e.goto = function (t) {
        ...
        if (s.isNumeric(t)) e.publish(n.GO_TO_PAGE, +(t - 1));
